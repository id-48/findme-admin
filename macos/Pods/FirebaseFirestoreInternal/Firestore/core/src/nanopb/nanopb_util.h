 ...
 */
            ...
            MakeBytesArray(const void *_Nullable data,
                           size_t size);
 ...
 */
            inline pb_bytes_array_t *_Nullable
 ...
 */
            ...
            MakeBytesArray(const std::string &str) {
 ...
 */
        ...
        ResizeArray(void *_Nonnull ptr, size_t count) {
 ...
 */
        ...
        void SetRepeatedField(T *_Nonnull

        *
        _Nonnull fields_array,
                pb_size_t
        *
        _Nonnull fields_count,
                Iterator
        first,
        Iterator last,
        const Func &converter
        ) {
        HARD_ASSERT(fields_array,
        "fields_array must be non-null");
        HARD_ASSERT(fields_count,
        "fields_count must be non-null");
        *
...
return
SetRepeatedField(fields_array, fields_count, fields
.
