 ...
 */
            ...
            constexpr bool Ascending(ComparisonResult result)
        ...
        constexpr bool Same(ComparisonResult result)
    ...
    constexpr bool Descending(ComparisonResult result)
...
ComparisonResultFromInt(int value) {
 ...
 */
constexpr ComparisonResult
ReverseOrder(ComparisonResult
result) {
return static_cast<ComparisonResult>(-static_cast
<int>(result)
);
}
...
public:
    ...
    ComparisonResult(const T &, const T &)
