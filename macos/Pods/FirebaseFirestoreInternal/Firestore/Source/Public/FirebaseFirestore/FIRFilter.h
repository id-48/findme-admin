 ...
 */
+ (FIRFilter *)filterWhereField:(nonnull NSString
...
value NS_SWIFT_NAME(whereField(_
:isEqualTo:));
 ...
 * @return The newly created filter.
 */
+ (FIRFilter *)filterWhereFieldPath:(nonnull FIRFieldPath
...
nonnull NSArray<id>
*)
values NS_SWIFT_NAME(whereField(_
:in:));
 ...
 * @return The newly created filter.
 */
+ (FIRFilter *)orFilterWithFilters:(NSArray

<FIRFilter *> *)
filters NS_SWIFT_NAME(orFilter(_
:));
 ...
 * @return The newly created filter.
 */
+ (FIRFilter *)andFilterWithFilters:(NSArray

<FIRFilter *> *)
filters NS_SWIFT_NAME(andFilter(_
:));
