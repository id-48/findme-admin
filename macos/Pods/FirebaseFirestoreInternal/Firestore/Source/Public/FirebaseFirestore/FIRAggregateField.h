 ...
 * a specified field over a range of documents in the result set of a query.
 */
+ (instancetype)aggregateFieldForSumOfField:(NSString *)field NS_SWIFT_NAME
 ...
 * a specified field over a range of documents in the result set of a query.
 */
+ (instancetype)aggregateFieldForSumOfFieldPath:(FIRFieldPath *)fieldPath NS_SWIFT_NAME
 ...
 * a specified field over a range of documents in the result set of a query.
 */
+ (instancetype)aggregateFieldForAverageOfField:(NSString *)field NS_SWIFT_NAME
