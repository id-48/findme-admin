...
#error Regenerate this file with the current version of nanopb generator.
        ...
        const pb_field_t google_firestore_v1_BitSequence_fields[3] = {
                PB_FIELD(1, BYTES, SINGULAR, POINTER, FIRST, google_firestore_v1_BitSequence,
                         bitmap, bitmap, 0),
                PB_FIELD(2, INT32, SINGULAR, STATIC, OTHER, google_firestore_v1_BitSequence,
                         padding, bitmap, 0),
                PB_LAST_FIELD
        };

        const pb_field_t google_firestore_v1_BloomFilter_fields[3] = {
                PB_FIELD(1, MESSAGE, OPTIONAL, STATIC, FIRST, google_firestore_v1_BloomFilter, bits,
                         bits, &google_firestore_v1_BitSequence_fields),
                PB_FIELD(2, INT32, SINGULAR, STATIC, OTHER, google_firestore_v1_BloomFilter,
                         hash_count, bits, 0),
                PB_LAST_FIELD
        };
 ...
 * field descriptors.
 */
        PB_STATIC_ASSERT ((pb_membersize(google_firestore_v1_BloomFilter, bits)

        < 65536), YOU_MUST_DEFINE_PB_FIELD_32BIT_FOR_MESSAGES_google_firestore_v1_BitSequence_google_firestore_v1_BloomFilter)
#endif
 ...
 */
        ...
        < 256), YOU_MUST_DEFINE_PB_FIELD_16BIT_FOR_MESSAGES_google_firestore_v1_BitSequence_google_firestore_v1_BloomFilter)
#endif
