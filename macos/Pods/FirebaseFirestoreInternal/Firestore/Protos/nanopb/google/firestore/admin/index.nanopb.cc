...
#error Regenerate this file with the current version of nanopb generator.
        ...
        const pb_field_t google_firestore_admin_v1_Index_fields[5] = {
                PB_FIELD(1, BYTES, SINGULAR, POINTER, FIRST, google_firestore_admin_v1_Index, name,
                         name, 0),
                PB_FIELD(2, UENUM, SINGULAR, STATIC, OTHER, google_firestore_admin_v1_Index,
                         query_scope, name, 0),
                PB_FIELD(3, MESSAGE, REPEATED, POINTER, OTHER, google_firestore_admin_v1_Index,
                         fields, query_scope, &google_firestore_admin_v1_Index_IndexField_fields),
                PB_FIELD(4, UENUM, SINGULAR, STATIC, OTHER, google_firestore_admin_v1_Index, state,
                         fields, 0),
                PB_LAST_FIELD
        };
        ...
        const pb_field_t google_firestore_admin_v1_Index_IndexField_fields[4] = {
                PB_FIELD(1, BYTES, SINGULAR, POINTER, FIRST,
                         google_firestore_admin_v1_Index_IndexField, field_path, field_path, 0),
                PB_ANONYMOUS_ONEOF_FIELD(value_mode, 2, UENUM, ONEOF, STATIC, OTHER,
                                         google_firestore_admin_v1_Index_IndexField, order,
                                         field_path, 0),
                PB_ANONYMOUS_ONEOF_FIELD(value_mode, 3, UENUM, ONEOF, STATIC, UNION,
                                         google_firestore_admin_v1_Index_IndexField, array_config,
                                         field_path, 0),
                PB_LAST_FIELD
        };
