...
#error Regenerate this file with the current version of nanopb generator.
        ...
        const pb_field_t google_api_ResourceDescriptor_fields[7] = {
                PB_FIELD(1, BYTES, SINGULAR, POINTER, FIRST, google_api_ResourceDescriptor, type,
                         type, 0),
                PB_FIELD(2, BYTES, REPEATED, POINTER, OTHER, google_api_ResourceDescriptor, pattern,
                         type, 0),
                PB_FIELD(3, BYTES, SINGULAR, POINTER, OTHER, google_api_ResourceDescriptor,
                         name_field, pattern, 0),
                PB_FIELD(4, UENUM, SINGULAR, STATIC, OTHER, google_api_ResourceDescriptor, history,
                         name_field, 0),
                PB_FIELD(5, BYTES, SINGULAR, POINTER, OTHER, google_api_ResourceDescriptor, plural,
                         history, 0),
                PB_FIELD(6, BYTES, SINGULAR, POINTER, OTHER, google_api_ResourceDescriptor,
                         singular, plural, 0),
                PB_LAST_FIELD
        };

        const pb_field_t google_api_ResourceReference_fields[3] = {
                PB_FIELD(1, BYTES, SINGULAR, POINTER, FIRST, google_api_ResourceReference, type,
                         type, 0),
                PB_FIELD(2, BYTES, SINGULAR, POINTER, OTHER, google_api_ResourceReference,
                         child_type, type, 0),
                PB_LAST_FIELD
        };
 ...
 * field descriptors.
 */
        PB_STATIC_ASSERT ((pb_membersize(google_api_resource_reference_struct, resource_reference)

        < 65536 &&
        pb_membersize(google_api_resource_struct, resource
        ) < 65536), YOU_MUST_DEFINE_PB_FIELD_32BIT_FOR_MESSAGES_google_api_ResourceDescriptor_google_api_ResourceReference)
#endif
