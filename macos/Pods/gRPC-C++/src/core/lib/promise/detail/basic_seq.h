...
// that state is inlined in BasicSeq since that was simpler to type.
        ...
        struct SeqState {
            ...
            union {
                ...
                GPR_NO_UNIQUE_ADDRESS PriorState
                prior;
                // The callables representing our promise.
                GPR_NO_UNIQUE_ADDRESS typename Types::Promise
                current_promise;
            };
            // Storage for the next promise factory.
            GPR_NO_UNIQUE_ADDRESS typename Types::Next
            next_factory;
        };
...
//    run_next(std::move(prior)).
    ...
    private:
        ...
        union {
            GPR_NO_UNIQUE_ADDRESS PenultimateState
            penultimate_state_;
            GPR_NO_UNIQUE_ADDRESS FinalPromise
            final_promise_;
        };
        ...
        template<char I>
        absl::enable_if_t<I < N - 2, SeqState < Traits, I, Fs...>*>
...
// expected to return a promise that resolves to IterTraits::Wrapped.
    ...
    public:
        ...
        BasicSeqIter(BasicSeqIter &&other)

        noexcept
                : cur_(other.cur_), end_(other
        .end_),
        ...
        BasicSeqIter &operator=(BasicSeqIter &&other)
    ...
    private:
        ...
        Iter cur_;
        const Iter end_;
        GPR_NO_UNIQUE_ADDRESS Factory
        f_;
        union {
            GPR_NO_UNIQUE_ADDRESS State
            state_;
            GPR_NO_UNIQUE_ADDRESS Argument
            result_;
        };
    };
