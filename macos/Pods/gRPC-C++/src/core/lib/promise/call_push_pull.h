...
namespace grpc_core {
    ...
    namespace promise_detail {
        ...
        public:
            ...
            CallPushPull(CallPushPull &&other)

            noexcept
                    : done_(other.done_),
                    push_(std::move(other
            .push_)),

            pull_ (std::move(other
            ...
            CallPushPull &operator=(CallPushPull &&other)
        ...
        private:
            enum {
                kDonePull = 0, kDoneMain = 1, kDonePush = 2
            };
            BitSet<3> done_;
            GPR_NO_UNIQUE_ADDRESS PromiseLike<FPush>
            push_;
            union {
                PromiseLike <FMain> main_;
                Result result_;
            };
            GPR_NO_UNIQUE_ADDRESS PromiseLike<FPull>
            pull_;
        };
