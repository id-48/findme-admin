...
// Member functions are thread safe.
    ...
    private:
        ...
        absl::flat_hash_map<int, int> next_seq_num_
        ABSL_GUARDED_BY(write_mu_);
        ...
        int64_t num_acknowledged_bytes_
        ABSL_GUARDED_BY(flow_control_mu_) = 0;
        ...
        int num_non_acked_tx_in_combiner_
        ABSL_GUARDED_BY(flow_control_mu_) = 0;
