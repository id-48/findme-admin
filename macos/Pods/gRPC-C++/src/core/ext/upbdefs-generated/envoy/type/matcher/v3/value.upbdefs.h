...
*
envoy_type_matcher_v3_ValueMatcher_getmsgdef(upb_DefPool
*s) {
...
UPB_INLINE const upb_MessageDef
*
envoy_type_matcher_v3_ValueMatcher_NullMatch_getmsgdef(upb_DefPool
*s) {
_upb_DefPool_LoadDefInit(s, &envoy_type_matcher_v3_value_proto_upbdefinit
);
return
...
UPB_INLINE const upb_MessageDef
*
envoy_type_matcher_v3_ListMatcher_getmsgdef(upb_DefPool
*s) {
_upb_DefPool_LoadDefInit(s, &envoy_type_matcher_v3_value_proto_upbdefinit
);
return
