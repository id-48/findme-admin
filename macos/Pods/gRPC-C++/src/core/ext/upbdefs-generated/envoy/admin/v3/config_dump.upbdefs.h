...
*
envoy_admin_v3_ConfigDump_getmsgdef(upb_DefPool
*s) {
...
UPB_INLINE const upb_MessageDef
*
envoy_admin_v3_BootstrapConfigDump_getmsgdef(upb_DefPool
*s) {
_upb_DefPool_LoadDefInit(s, &envoy_admin_v3_config_dump_proto_upbdefinit
);
return
...
UPB_INLINE const upb_MessageDef
*
envoy_admin_v3_SecretsConfigDump_getmsgdef(upb_DefPool
*s) {
_upb_DefPool_LoadDefInit(s, &envoy_admin_v3_config_dump_proto_upbdefinit
);
return
...
UPB_INLINE const upb_MessageDef
*
envoy_admin_v3_SecretsConfigDump_DynamicSecret_getmsgdef(upb_DefPool
*s) {
_upb_DefPool_LoadDefInit(s, &envoy_admin_v3_config_dump_proto_upbdefinit
);
return
...
UPB_INLINE const upb_MessageDef
*
envoy_admin_v3_SecretsConfigDump_StaticSecret_getmsgdef(upb_DefPool
*s) {
_upb_DefPool_LoadDefInit(s, &envoy_admin_v3_config_dump_proto_upbdefinit
);
return
