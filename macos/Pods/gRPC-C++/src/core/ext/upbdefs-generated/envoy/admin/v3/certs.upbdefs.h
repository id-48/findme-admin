...
*
envoy_admin_v3_Certificates_getmsgdef(upb_DefPool
*s) {
...
UPB_INLINE const upb_MessageDef
*
envoy_admin_v3_Certificate_getmsgdef(upb_DefPool
*s) {
_upb_DefPool_LoadDefInit(s, &envoy_admin_v3_certs_proto_upbdefinit
);
return
...
UPB_INLINE const upb_MessageDef
*
envoy_admin_v3_CertificateDetails_getmsgdef(upb_DefPool
*s) {
_upb_DefPool_LoadDefInit(s, &envoy_admin_v3_certs_proto_upbdefinit
);
return
...
UPB_INLINE const upb_MessageDef
*
envoy_admin_v3_CertificateDetails_OcspDetails_getmsgdef(upb_DefPool
*s) {
_upb_DefPool_LoadDefInit(s, &envoy_admin_v3_certs_proto_upbdefinit
);
return
...
UPB_INLINE const upb_MessageDef
*
envoy_admin_v3_SubjectAlternateName_getmsgdef(upb_DefPool
*s) {
_upb_DefPool_LoadDefInit(s, &envoy_admin_v3_certs_proto_upbdefinit
);
return
