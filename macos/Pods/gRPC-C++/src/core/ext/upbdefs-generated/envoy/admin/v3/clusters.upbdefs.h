...
*
envoy_admin_v3_Clusters_getmsgdef(upb_DefPool
*s) {
...
UPB_INLINE const upb_MessageDef
*
envoy_admin_v3_ClusterStatus_getmsgdef(upb_DefPool
*s) {
_upb_DefPool_LoadDefInit(s, &envoy_admin_v3_clusters_proto_upbdefinit
);
return
...
UPB_INLINE const upb_MessageDef
*
envoy_admin_v3_HostStatus_getmsgdef(upb_DefPool
*s) {
_upb_DefPool_LoadDefInit(s, &envoy_admin_v3_clusters_proto_upbdefinit
);
return
...
UPB_INLINE const upb_MessageDef
*
envoy_admin_v3_HostHealthStatus_getmsgdef(upb_DefPool
*s) {
_upb_DefPool_LoadDefInit(s, &envoy_admin_v3_clusters_proto_upbdefinit
);
return
