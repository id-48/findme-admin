...
*
envoy_extensions_filters_http_fault_v3_FaultAbort_getmsgdef(upb_DefPool
*s) {
...
UPB_INLINE const upb_MessageDef
*
envoy_extensions_filters_http_fault_v3_FaultAbort_HeaderAbort_getmsgdef(upb_DefPool
*s) {
_upb_DefPool_LoadDefInit(s, &envoy_extensions_filters_http_fault_v3_fault_proto_upbdefinit
);
return
...
UPB_INLINE const upb_MessageDef
*
envoy_extensions_filters_http_fault_v3_HTTPFault_getmsgdef(upb_DefPool
*s) {
_upb_DefPool_LoadDefInit(s, &envoy_extensions_filters_http_fault_v3_fault_proto_upbdefinit
);
return
