...
UPB_INLINE google_api_Http
*
google_api_Http_new(upb_Arena
* arena) {
return (google_api_Http*)
_upb_Message_New(&google_api_Http_msginit, arena
);
}
UPB_INLINE google_api_Http
*

google_api_Http_parse(const char *buf, size_t size, upb_Arena *arena) {
    google_api_Http * ret = google_api_Http_new(arena);
    if (!ret) return NULL;
    if (upb_Decode(buf, size, ret, &google_api_Http_msginit, NULL, 0, arena) !=
...
google_api_Http_parse_ex(const char *buf, size_t size,
...
UPB_INLINE char *
google_api_Http_serialize(const google_api_Http *msg, upb_Arena *arena, size_t *len) {
    char *ptr;
...
UPB_INLINE const google_api_HttpRule
* const*

google_api_Http_rules(const google_api_Http *msg, size_t *len) {
...
**
google_api_Http_mutable_rules(google_api_Http
* msg,
size_t *len
) {
return (google_api_HttpRule**)
_upb_array_mutable_accessor(msg, UPB_SIZE(4, 8), len
);
}
UPB_INLINE google_api_HttpRule
**
google_api_Http_resize_rules(google_api_Http
* msg,
...
UPB_INLINE struct google_api_HttpRule *
google_api_Http_add_rules(google_api_Http * msg, upb_Arena * arena) {
    struct google_api_HttpRule *sub = (struct google_api_HttpRule *) _upb_Message_New(
            &google_api_HttpRule_msginit, arena);
    bool ok = _upb_Array_Append_accessor2(msg, UPB_SIZE(4, 8), UPB_SIZE(2, 3), &sub, arena);
    if (!ok) return NULL;
    return sub;
}

UPB_INLINE void google_api_Http_set_fully_decode_reserved_expansion(google_api_Http * msg, bool
value) {
*
...
UPB_INLINE google_api_HttpRule
*
google_api_HttpRule_new(upb_Arena
* arena) {
return (google_api_HttpRule*)
_upb_Message_New(&google_api_HttpRule_msginit, arena
);
}
UPB_INLINE google_api_HttpRule
*

google_api_HttpRule_parse(const char *buf, size_t size, upb_Arena *arena) {
    google_api_HttpRule * ret = google_api_HttpRule_new(arena);
    if (!ret) return NULL;
    if (upb_Decode(buf, size, ret, &google_api_HttpRule_msginit, NULL, 0, arena) !=
        kUpb_DecodeStatus_Ok) {
        return NULL;
    }
    return ret;
...
google_api_HttpRule_parse_ex(const char *buf, size_t size,
                             const upb_ExtensionRegistry *extreg,
                             int options, upb_Arena *arena) {
    google_api_HttpRule * ret = google_api_HttpRule_new(arena);
    if (!ret) return NULL;
...
UPB_INLINE char *
google_api_HttpRule_serialize(const google_api_HttpRule *msg, upb_Arena *arena, size_t *len) {
    char *ptr;
...
UPB_INLINE google_api_HttpRule_pattern_oneofcases

google_api_HttpRule_pattern_case(const google_api_HttpRule *msg) {
...
google_api_HttpRule_selector(const google_api_HttpRule *msg) {
...
UPB_INLINE void google_api_HttpRule_clear_get(const google_api_HttpRule *msg) {
    UPB_WRITE_ONEOF(msg, upb_StringView, UPB_SIZE(4, 8), upb_StringView_FromDataAndSize(NULL, 0),
                    UPB_SIZE(0, 0), google_api_HttpRule_pattern_NOT_SET);
}

UPB_INLINE upb_StringView

google_api_HttpRule_get(const google_api_HttpRule *msg) {
...
google_api_HttpRule_put(const google_api_HttpRule *msg) {
...
google_api_HttpRule_post(const google_api_HttpRule *msg) {
...
google_api_HttpRule_delete(const google_api_HttpRule *msg) {
    return UPB_READ_ONEOF(msg, upb_StringView, UPB_SIZE(4, 8), UPB_SIZE(0, 0), 5,
                          upb_StringView_FromString(""));
}
...
google_api_HttpRule_patch(const google_api_HttpRule *msg) {
    return UPB_READ_ONEOF(msg, upb_StringView, UPB_SIZE(4, 8), UPB_SIZE(0, 0), 6,
                          upb_StringView_FromString(""));
}
...
google_api_HttpRule_body(const google_api_HttpRule *msg) {
...
UPB_INLINE void google_api_HttpRule_clear_custom(const google_api_HttpRule *msg) {
    UPB_WRITE_ONEOF(msg, google_api_CustomHttpPattern * , UPB_SIZE(4, 8), 0, UPB_SIZE(0, 0),
                    google_api_HttpRule_pattern_NOT_SET);
}

UPB_INLINE const google_api_CustomHttpPattern
*

google_api_HttpRule_custom(const google_api_HttpRule *msg) {
    return UPB_READ_ONEOF(msg,
    const google_api_CustomHttpPattern*, UPB_SIZE(4, 8), UPB_SIZE(0, 0), 8, NULL);
}
...
google_api_HttpRule_additional_bindings(const google_api_HttpRule *msg, size_t *len) {
...
google_api_HttpRule_response_body(const google_api_HttpRule *msg) {
    return *UPB_PTR_AT(msg, UPB_SIZE(32, 64), upb_StringView);
}

UPB_INLINE void google_api_HttpRule_set_selector(google_api_HttpRule * msg, upb_StringView
value) {
*
...
UPB_INLINE void google_api_HttpRule_set_get(google_api_HttpRule * msg, upb_StringView
value) {
UPB_WRITE_ONEOF(msg, upb_StringView, UPB_SIZE(4, 8), value, UPB_SIZE(0, 0),
2);
}
UPB_INLINE void google_api_HttpRule_set_put(google_api_HttpRule * msg, upb_StringView
value) {
UPB_WRITE_ONEOF(msg, upb_StringView, UPB_SIZE(4, 8), value, UPB_SIZE(0, 0),
3);
}
UPB_INLINE void google_api_HttpRule_set_post(google_api_HttpRule * msg, upb_StringView
value) {
UPB_WRITE_ONEOF(msg, upb_StringView, UPB_SIZE(4, 8), value, UPB_SIZE(0, 0),
4);
}
UPB_INLINE void google_api_HttpRule_set_delete(google_api_HttpRule * msg, upb_StringView
value) {
UPB_WRITE_ONEOF(msg, upb_StringView, UPB_SIZE(4, 8), value, UPB_SIZE(0, 0),
5);
}
UPB_INLINE void google_api_HttpRule_set_patch(google_api_HttpRule * msg, upb_StringView
value) {
UPB_WRITE_ONEOF(msg, upb_StringView, UPB_SIZE(4, 8), value, UPB_SIZE(0, 0),
6);
}
UPB_INLINE void google_api_HttpRule_set_body(google_api_HttpRule * msg, upb_StringView
value) {
*
...
UPB_INLINE void
google_api_HttpRule_set_custom(google_api_HttpRule * msg, google_api_CustomHttpPattern * value) {
    UPB_WRITE_ONEOF(msg, google_api_CustomHttpPattern * , UPB_SIZE(4, 8), value, UPB_SIZE(0, 0), 8);
}

UPB_INLINE struct google_api_CustomHttpPattern *
google_api_HttpRule_mutable_custom(google_api_HttpRule * msg, upb_Arena * arena) {
    struct google_api_CustomHttpPattern *sub = (struct google_api_CustomHttpPattern *) google_api_HttpRule_custom(
            msg);
    if (sub == NULL) {
        sub = (struct google_api_CustomHttpPattern *) _upb_Message_New(
                &google_api_CustomHttpPattern_msginit, arena);
        if (!sub) return NULL;
...
UPB_INLINE google_api_HttpRule
**
google_api_HttpRule_mutable_additional_bindings(google_api_HttpRule
* msg,
size_t *len
) {
return (google_api_HttpRule**)
...
UPB_INLINE google_api_HttpRule
**
google_api_HttpRule_resize_additional_bindings(google_api_HttpRule
* msg,
size_t len, upb_Arena
* arena) {
return (google_api_HttpRule**)
...
UPB_INLINE struct google_api_HttpRule *
google_api_HttpRule_add_additional_bindings(google_api_HttpRule * msg, upb_Arena * arena) {
    struct google_api_HttpRule *sub = (struct google_api_HttpRule *) _upb_Message_New(
            &google_api_HttpRule_msginit, arena);
...
UPB_INLINE void google_api_HttpRule_set_response_body(google_api_HttpRule * msg, upb_StringView
value) {
*
...
UPB_INLINE google_api_CustomHttpPattern
*
google_api_CustomHttpPattern_new(upb_Arena
* arena) {
return (google_api_CustomHttpPattern*)
_upb_Message_New(&google_api_CustomHttpPattern_msginit, arena
);
}
UPB_INLINE google_api_CustomHttpPattern
*

google_api_CustomHttpPattern_parse(const char *buf, size_t size, upb_Arena *arena) {
    google_api_CustomHttpPattern * ret = google_api_CustomHttpPattern_new(arena);
    if (!ret) return NULL;
    if (upb_Decode(buf, size, ret, &google_api_CustomHttpPattern_msginit, NULL, 0, arena) !=
        kUpb_DecodeStatus_Ok) {
        return NULL;
    }
    return ret;
...
google_api_CustomHttpPattern_parse_ex(const char *buf, size_t size,
                                      const upb_ExtensionRegistry *extreg,
                                      int options, upb_Arena *arena) {
    google_api_CustomHttpPattern * ret = google_api_CustomHttpPattern_new(arena);
    if (!ret) return NULL;
...
UPB_INLINE char *
google_api_CustomHttpPattern_serialize(const google_api_CustomHttpPattern *msg, upb_Arena *arena,
                                       size_t *len) {
    char *ptr;
...
UPB_INLINE char *
google_api_CustomHttpPattern_serialize_ex(const google_api_CustomHttpPattern *msg, int options,
                                          upb_Arena *arena, size_t *len) {
    char *ptr;
...
google_api_CustomHttpPattern_kind(const google_api_CustomHttpPattern *msg) {
...
google_api_CustomHttpPattern_path(const google_api_CustomHttpPattern *msg) {
