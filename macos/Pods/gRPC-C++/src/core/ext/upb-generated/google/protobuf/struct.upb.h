...
UPB_INLINE google_protobuf_Struct
*
google_protobuf_Struct_new(upb_Arena
* arena) {
return (google_protobuf_Struct*)
_upb_Message_New(&google_protobuf_Struct_msginit, arena
);
}
UPB_INLINE google_protobuf_Struct
*

google_protobuf_Struct_parse(const char *buf, size_t size, upb_Arena *arena) {
    google_protobuf_Struct * ret = google_protobuf_Struct_new(arena);
    if (!ret) return NULL;
    if (upb_Decode(buf, size, ret, &google_protobuf_Struct_msginit, NULL, 0, arena) !=
...
google_protobuf_Struct_parse_ex(const char *buf, size_t size,
...
UPB_INLINE char *
google_protobuf_Struct_serialize(const google_protobuf_Struct *msg, upb_Arena *arena, size_t *len) {
    char *ptr;
...
google_protobuf_Struct_fields_size(const google_protobuf_Struct *msg) {
    return _upb_msg_map_size(msg, UPB_SIZE(0, 0));
}

UPB_INLINE bool
google_protobuf_Struct_fields_get(const google_protobuf_Struct *msg, upb_StringView key,
                                  google_protobuf_Value **val) {
    return _upb_msg_map_get(msg, UPB_SIZE(0, 0), &key, 0, val, sizeof(*val));
}

UPB_INLINE const google_protobuf_Struct_FieldsEntry
*

google_protobuf_Struct_fields_next(const google_protobuf_Struct *msg, size_t *iter) {
    return (const google_protobuf_Struct_FieldsEntry *) _upb_msg_map_next(msg, UPB_SIZE(0, 0),
                                                                          iter);
}

UPB_INLINE void
google_protobuf_Struct_fields_clear(google_protobuf_Struct * msg) { _upb_msg_map_clear(msg,
                                                                                       UPB_SIZE(0,
                                                                                                0));
}

UPB_INLINE bool google_protobuf_Struct_fields_set(google_protobuf_Struct * msg, upb_StringView
key,
google_protobuf_Value *val, upb_Arena
* a) {
return
_upb_msg_map_set(msg, UPB_SIZE(0, 0), &key,
0, &val, sizeof(val), a);
}
UPB_INLINE bool google_protobuf_Struct_fields_delete(google_protobuf_Struct * msg, upb_StringView
key) {
return
...
*
google_protobuf_Struct_fields_nextmutable(google_protobuf_Struct
* msg,
size_t *iter
) {
return (google_protobuf_Struct_FieldsEntry*)
...
google_protobuf_Struct_FieldsEntry_key(const google_protobuf_Struct_FieldsEntry *msg) {
    upb_StringView ret;
...
UPB_INLINE bool
google_protobuf_Struct_FieldsEntry_has_value(const google_protobuf_Struct_FieldsEntry *msg) {
...
google_protobuf_Struct_FieldsEntry_value(const google_protobuf_Struct_FieldsEntry *msg) {
...
UPB_INLINE void
google_protobuf_Struct_FieldsEntry_set_value(google_protobuf_Struct_FieldsEntry * msg,
...
UPB_INLINE google_protobuf_Value
*
google_protobuf_Value_new(upb_Arena
* arena) {
return (google_protobuf_Value*)
_upb_Message_New(&google_protobuf_Value_msginit, arena
);
}
UPB_INLINE google_protobuf_Value
*

google_protobuf_Value_parse(const char *buf, size_t size, upb_Arena *arena) {
    google_protobuf_Value * ret = google_protobuf_Value_new(arena);
    if (!ret) return NULL;
    if (upb_Decode(buf, size, ret, &google_protobuf_Value_msginit, NULL, 0, arena) !=
        kUpb_DecodeStatus_Ok) {
        return NULL;
    }
    return ret;
...
google_protobuf_Value_parse_ex(const char *buf, size_t size,
                               const upb_ExtensionRegistry *extreg,
                               int options, upb_Arena *arena) {
    google_protobuf_Value * ret = google_protobuf_Value_new(arena);
    if (!ret) return NULL;
...
UPB_INLINE char *
google_protobuf_Value_serialize(const google_protobuf_Value *msg, upb_Arena *arena, size_t *len) {
    char *ptr;
...
UPB_INLINE void google_protobuf_Value_clear_string_value(const google_protobuf_Value *msg) {
    UPB_WRITE_ONEOF(msg, upb_StringView, UPB_SIZE(8, 8), upb_StringView_FromDataAndSize(NULL, 0),
                    UPB_SIZE(0, 0), google_protobuf_Value_kind_NOT_SET);
}

UPB_INLINE upb_StringView

google_protobuf_Value_string_value(const google_protobuf_Value *msg) {
    return UPB_READ_ONEOF(msg, upb_StringView, UPB_SIZE(8, 8), UPB_SIZE(0, 0), 3,
...
UPB_INLINE void google_protobuf_Value_clear_struct_value(const google_protobuf_Value *msg) {
    UPB_WRITE_ONEOF(msg, google_protobuf_Struct * , UPB_SIZE(8, 8), 0, UPB_SIZE(0, 0),
                    google_protobuf_Value_kind_NOT_SET);
}

UPB_INLINE const google_protobuf_Struct
*

google_protobuf_Value_struct_value(const google_protobuf_Value *msg) {
    return UPB_READ_ONEOF(msg,
    const google_protobuf_Struct*, UPB_SIZE(8, 8), UPB_SIZE(0, 0), 5, NULL);
}
...
UPB_INLINE void google_protobuf_Value_clear_list_value(const google_protobuf_Value *msg) {
    UPB_WRITE_ONEOF(msg, google_protobuf_ListValue * , UPB_SIZE(8, 8), 0, UPB_SIZE(0, 0),
                    google_protobuf_Value_kind_NOT_SET);
}

UPB_INLINE const google_protobuf_ListValue
*

google_protobuf_Value_list_value(const google_protobuf_Value *msg) {
    return UPB_READ_ONEOF(msg,
    const google_protobuf_ListValue*, UPB_SIZE(8, 8), UPB_SIZE(0, 0), 6, NULL);
}

UPB_INLINE void google_protobuf_Value_set_null_value(google_protobuf_Value * msg, int32_t
value) {
UPB_WRITE_ONEOF(msg, int32_t, UPB_SIZE(8, 8), value, UPB_SIZE(0, 0),
1);
}
UPB_INLINE void google_protobuf_Value_set_number_value(google_protobuf_Value * msg, double
value) {
UPB_WRITE_ONEOF(msg,
double, UPB_SIZE(8, 8), value, UPB_SIZE(0, 0), 2);
}
UPB_INLINE void google_protobuf_Value_set_string_value(google_protobuf_Value * msg, upb_StringView
value) {
UPB_WRITE_ONEOF(msg, upb_StringView, UPB_SIZE(8, 8), value, UPB_SIZE(0, 0),
3);
}
UPB_INLINE void google_protobuf_Value_set_bool_value(google_protobuf_Value * msg, bool
value) {
UPB_WRITE_ONEOF(msg,
bool, UPB_SIZE(8, 8), value, UPB_SIZE(0, 0), 4);
}
...
google_protobuf_Value_mutable_struct_value(google_protobuf_Value * msg, upb_Arena * arena) {
    struct google_protobuf_Struct *sub = (struct google_protobuf_Struct *) google_protobuf_Value_struct_value(
            msg);
    if (sub == NULL) {
...
UPB_INLINE struct google_protobuf_ListValue *
google_protobuf_Value_mutable_list_value(google_protobuf_Value * msg, upb_Arena * arena) {
    struct google_protobuf_ListValue *sub = (struct google_protobuf_ListValue *) google_protobuf_Value_list_value(
            msg);
    if (sub == NULL) {
        sub = (struct google_protobuf_ListValue *) _upb_Message_New(
                &google_protobuf_ListValue_msginit, arena);
        if (!sub) return NULL;
...
UPB_INLINE google_protobuf_ListValue
*
google_protobuf_ListValue_new(upb_Arena
* arena) {
return (google_protobuf_ListValue*)
_upb_Message_New(&google_protobuf_ListValue_msginit, arena
);
}
UPB_INLINE google_protobuf_ListValue
*

google_protobuf_ListValue_parse(const char *buf, size_t size, upb_Arena *arena) {
    google_protobuf_ListValue * ret = google_protobuf_ListValue_new(arena);
    if (!ret) return NULL;
    if (upb_Decode(buf, size, ret, &google_protobuf_ListValue_msginit, NULL, 0, arena) !=
        kUpb_DecodeStatus_Ok) {
        return NULL;
    }
    return ret;
...
google_protobuf_ListValue_parse_ex(const char *buf, size_t size,
                                   const upb_ExtensionRegistry *extreg,
                                   int options, upb_Arena *arena) {
    google_protobuf_ListValue * ret = google_protobuf_ListValue_new(arena);
    if (!ret) return NULL;
...
UPB_INLINE char *
google_protobuf_ListValue_serialize(const google_protobuf_ListValue *msg, upb_Arena *arena,
                                    size_t *len) {
    char *ptr;
...
UPB_INLINE char *
google_protobuf_ListValue_serialize_ex(const google_protobuf_ListValue *msg, int options,
                                       upb_Arena *arena, size_t *len) {
    char *ptr;
...
google_protobuf_ListValue_values(const google_protobuf_ListValue *msg, size_t *len) {
    return (const google_protobuf_Value *const *) _upb_array_accessor(msg, UPB_SIZE(0, 0), len);
}

UPB_INLINE google_protobuf_Value
**
google_protobuf_ListValue_mutable_values(google_protobuf_ListValue
* msg,
size_t *len
) {
return (google_protobuf_Value**)
...
UPB_INLINE google_protobuf_Value
**
google_protobuf_ListValue_resize_values(google_protobuf_ListValue
* msg,
...
UPB_INLINE struct google_protobuf_Value *
google_protobuf_ListValue_add_values(google_protobuf_ListValue * msg, upb_Arena * arena) {
    struct google_protobuf_Value *sub = (struct google_protobuf_Value *) _upb_Message_New(
            &google_protobuf_Value_msginit, arena);
