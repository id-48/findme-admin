...
UPB_INLINE google_protobuf_Empty
*
google_protobuf_Empty_new(upb_Arena
* arena) {
return (google_protobuf_Empty*)
_upb_Message_New(&google_protobuf_Empty_msginit, arena
);
}
UPB_INLINE google_protobuf_Empty
*

google_protobuf_Empty_parse(const char *buf, size_t size, upb_Arena *arena) {
    google_protobuf_Empty * ret = google_protobuf_Empty_new(arena);
    if (!ret) return NULL;
    if (upb_Decode(buf, size, ret, &google_protobuf_Empty_msginit, NULL, 0, arena) !=
...
google_protobuf_Empty_parse_ex(const char *buf, size_t size,
...
UPB_INLINE char *
google_protobuf_Empty_serialize(const google_protobuf_Empty *msg, upb_Arena *arena, size_t *len) {
    char *ptr;
