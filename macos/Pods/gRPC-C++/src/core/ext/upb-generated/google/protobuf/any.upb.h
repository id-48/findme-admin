...
UPB_INLINE google_protobuf_Any
*
google_protobuf_Any_new(upb_Arena
* arena) {
return (google_protobuf_Any*)
_upb_Message_New(&google_protobuf_Any_msginit, arena
);
}
UPB_INLINE google_protobuf_Any
*

google_protobuf_Any_parse(const char *buf, size_t size, upb_Arena *arena) {
    google_protobuf_Any * ret = google_protobuf_Any_new(arena);
    if (!ret) return NULL;
    if (upb_Decode(buf, size, ret, &google_protobuf_Any_msginit, NULL, 0, arena) !=
...
google_protobuf_Any_parse_ex(const char *buf, size_t size,
...
UPB_INLINE char *
google_protobuf_Any_serialize(const google_protobuf_Any *msg, upb_Arena *arena, size_t *len) {
    char *ptr;
...
UPB_INLINE void google_protobuf_Any_set_type_url(google_protobuf_Any * msg, upb_StringView
value) {
*
...
UPB_INLINE void google_protobuf_Any_set_value(google_protobuf_Any * msg, upb_StringView
value) {
*
