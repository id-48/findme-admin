...
UPB_INLINE xds_core_v3_ResourceName
*
xds_core_v3_ResourceName_new(upb_Arena
* arena) {
return (xds_core_v3_ResourceName*)
_upb_Message_New(&xds_core_v3_ResourceName_msginit, arena
);
}
UPB_INLINE xds_core_v3_ResourceName
*

xds_core_v3_ResourceName_parse(const char *buf, size_t size, upb_Arena *arena) {
    xds_core_v3_ResourceName * ret = xds_core_v3_ResourceName_new(arena);
    if (!ret) return NULL;
    if (upb_Decode(buf, size, ret, &xds_core_v3_ResourceName_msginit, NULL, 0, arena) !=
...
xds_core_v3_ResourceName_parse_ex(const char *buf, size_t size,
...
UPB_INLINE char *
xds_core_v3_ResourceName_serialize(const xds_core_v3_ResourceName *msg, upb_Arena *arena,
                                   size_t *len) {
    char *ptr;
...
UPB_INLINE char *
xds_core_v3_ResourceName_serialize_ex(const xds_core_v3_ResourceName *msg, int options,
...
xds_core_v3_ResourceName_id(const xds_core_v3_ResourceName *msg) {
...
xds_core_v3_ResourceName_authority(const xds_core_v3_ResourceName *msg) {
...
xds_core_v3_ResourceName_resource_type(const xds_core_v3_ResourceName *msg) {
...
xds_core_v3_ResourceName_context(const xds_core_v3_ResourceName *msg) {
    return *UPB_PTR_AT(msg, UPB_SIZE(28, 56),
    const struct xds_core_v3_ContextParams*);
}

UPB_INLINE void xds_core_v3_ResourceName_set_id(xds_core_v3_ResourceName * msg, upb_StringView
value) {
*
...
UPB_INLINE void xds_core_v3_ResourceName_set_authority(xds_core_v3_ResourceName * msg,
                                                       upb_StringView
value) {
*
...
UPB_INLINE void xds_core_v3_ResourceName_set_resource_type(xds_core_v3_ResourceName * msg,
                                                           upb_StringView
value) {
*
...
UPB_INLINE void xds_core_v3_ResourceName_set_context(xds_core_v3_ResourceName * msg,
...
xds_core_v3_ResourceName_mutable_context(xds_core_v3_ResourceName * msg, upb_Arena * arena) {
    struct xds_core_v3_ContextParams *sub = (struct xds_core_v3_ContextParams *) xds_core_v3_ResourceName_context(
            msg);
    if (sub == NULL) {
