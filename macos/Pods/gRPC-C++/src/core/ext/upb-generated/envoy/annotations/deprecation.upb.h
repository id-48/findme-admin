...
UPB_INLINE bool
envoy_annotations_has_disallowed_by_default(const struct google_protobuf_FieldOptions *msg) {
    return _upb_Message_Getext(msg, &envoy_annotations_disallowed_by_default_ext) != NULL;
}

UPB_INLINE void
envoy_annotations_clear_disallowed_by_default(struct google_protobuf_FieldOptions *msg) {
...
UPB_INLINE bool
envoy_annotations_has_deprecated_at_minor_version(const struct google_protobuf_FieldOptions *msg) {
    return _upb_Message_Getext(msg, &envoy_annotations_deprecated_at_minor_version_ext) != NULL;
}

UPB_INLINE void
envoy_annotations_clear_deprecated_at_minor_version(struct google_protobuf_FieldOptions *msg) {
...
UPB_INLINE bool envoy_annotations_has_disallowed_by_default_enum(
...
UPB_INLINE void
envoy_annotations_clear_disallowed_by_default_enum(struct google_protobuf_EnumValueOptions *msg) {
...
UPB_INLINE bool envoy_annotations_has_deprecated_at_minor_version_enum(
        const struct google_protobuf_EnumValueOptions *msg) {
    return _upb_Message_Getext(msg, &envoy_annotations_deprecated_at_minor_version_enum_ext) !=
           NULL;
}

UPB_INLINE void envoy_annotations_clear_deprecated_at_minor_version_enum(
...
envoy_annotations_deprecated_at_minor_version_enum(
        const struct google_protobuf_EnumValueOptions *msg) {
    const upb_Message_Extension *ext = _upb_Message_Getext(msg,
