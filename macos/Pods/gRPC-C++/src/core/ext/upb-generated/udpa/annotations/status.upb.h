...
UPB_INLINE udpa_annotations_StatusAnnotation
*
udpa_annotations_StatusAnnotation_new(upb_Arena
* arena) {
return (udpa_annotations_StatusAnnotation*)
_upb_Message_New(&udpa_annotations_StatusAnnotation_msginit, arena
);
}
UPB_INLINE udpa_annotations_StatusAnnotation
*

udpa_annotations_StatusAnnotation_parse(const char *buf, size_t size, upb_Arena *arena) {
    udpa_annotations_StatusAnnotation * ret = udpa_annotations_StatusAnnotation_new(arena);
    if (!ret) return NULL;
    if (upb_Decode(buf, size, ret, &udpa_annotations_StatusAnnotation_msginit, NULL, 0, arena) !=
...
udpa_annotations_StatusAnnotation_parse_ex(const char *buf, size_t size,
                                           const upb_ExtensionRegistry *extreg,
                                           int options, upb_Arena *arena) {
    udpa_annotations_StatusAnnotation * ret = udpa_annotations_StatusAnnotation_new(arena);
    if (!ret) return NULL;
    if (upb_Decode(buf, size, ret, &udpa_annotations_StatusAnnotation_msginit, extreg, options,
                   arena) !=
        kUpb_DecodeStatus_Ok) {
        return NULL;
    }
...
UPB_INLINE char *
udpa_annotations_StatusAnnotation_serialize(const udpa_annotations_StatusAnnotation *msg,
...
UPB_INLINE char *
udpa_annotations_StatusAnnotation_serialize_ex(const udpa_annotations_StatusAnnotation *msg,
                                               int options,
                                               upb_Arena *arena, size_t *len) {
    char *ptr;
...
UPB_INLINE void udpa_annotations_StatusAnnotation_clear_work_in_progress(
        const udpa_annotations_StatusAnnotation *msg) {
    *UPB_PTR_AT(msg, UPB_SIZE(0, 0), bool) = 0;
}

UPB_INLINE bool
udpa_annotations_StatusAnnotation_work_in_progress(const udpa_annotations_StatusAnnotation *msg) {
    return *UPB_PTR_AT(msg, UPB_SIZE(0, 0), bool);
}

UPB_INLINE void udpa_annotations_StatusAnnotation_clear_package_version_status(
        const udpa_annotations_StatusAnnotation *msg) {
...
UPB_INLINE void udpa_annotations_StatusAnnotation_set_work_in_progress(
        udpa_annotations_StatusAnnotation * msg, bool
value) {
*
...
UPB_INLINE void udpa_annotations_StatusAnnotation_set_package_version_status(
        udpa_annotations_StatusAnnotation * msg, int32_t
value) {
*
...
UPB_INLINE void udpa_annotations_set_file_status(struct google_protobuf_FileOptions *msg,
                                                 const udpa_annotations_StatusAnnotation *ext,
                                                 upb_Arena *arena) {
