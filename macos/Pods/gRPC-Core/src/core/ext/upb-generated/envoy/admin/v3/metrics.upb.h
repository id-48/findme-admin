...
UPB_INLINE envoy_admin_v3_SimpleMetric
*
envoy_admin_v3_SimpleMetric_new(upb_Arena
* arena) {
return (envoy_admin_v3_SimpleMetric*)
_upb_Message_New(&envoy_admin_v3_SimpleMetric_msginit, arena
);
}
UPB_INLINE envoy_admin_v3_SimpleMetric
*

envoy_admin_v3_SimpleMetric_parse(const char *buf, size_t size, upb_Arena *arena) {
    envoy_admin_v3_SimpleMetric * ret = envoy_admin_v3_SimpleMetric_new(arena);
    if (!ret) return NULL;
    if (upb_Decode(buf, size, ret, &envoy_admin_v3_SimpleMetric_msginit, NULL, 0, arena) !=
...
envoy_admin_v3_SimpleMetric_parse_ex(const char *buf, size_t size,
...
UPB_INLINE char *
envoy_admin_v3_SimpleMetric_serialize(const envoy_admin_v3_SimpleMetric *msg, upb_Arena *arena,
                                      size_t *len) {
    char *ptr;
...
UPB_INLINE char *
envoy_admin_v3_SimpleMetric_serialize_ex(const envoy_admin_v3_SimpleMetric *msg, int options,
...
envoy_admin_v3_SimpleMetric_type(const envoy_admin_v3_SimpleMetric *msg) {
...
envoy_admin_v3_SimpleMetric_value(const envoy_admin_v3_SimpleMetric *msg) {
...
envoy_admin_v3_SimpleMetric_name(const envoy_admin_v3_SimpleMetric *msg) {
    return *UPB_PTR_AT(msg, UPB_SIZE(4, 8), upb_StringView);
}

UPB_INLINE void envoy_admin_v3_SimpleMetric_set_type(envoy_admin_v3_SimpleMetric * msg, int32_t
value) {
*
...
UPB_INLINE void envoy_admin_v3_SimpleMetric_set_value(envoy_admin_v3_SimpleMetric * msg, uint64_t
value) {
*
...
UPB_INLINE void envoy_admin_v3_SimpleMetric_set_name(envoy_admin_v3_SimpleMetric * msg,
                                                     upb_StringView
value) {
*
