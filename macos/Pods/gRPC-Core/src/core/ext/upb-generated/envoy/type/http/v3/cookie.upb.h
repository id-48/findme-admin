...
UPB_INLINE envoy_type_http_v3_Cookie
*
envoy_type_http_v3_Cookie_new(upb_Arena
* arena) {
return (envoy_type_http_v3_Cookie*)
_upb_Message_New(&envoy_type_http_v3_Cookie_msginit, arena
);
}
UPB_INLINE envoy_type_http_v3_Cookie
*

envoy_type_http_v3_Cookie_parse(const char *buf, size_t size, upb_Arena *arena) {
    envoy_type_http_v3_Cookie * ret = envoy_type_http_v3_Cookie_new(arena);
    if (!ret) return NULL;
    if (upb_Decode(buf, size, ret, &envoy_type_http_v3_Cookie_msginit, NULL, 0, arena) !=
...
envoy_type_http_v3_Cookie_parse_ex(const char *buf, size_t size,
...
UPB_INLINE char *
envoy_type_http_v3_Cookie_serialize(const envoy_type_http_v3_Cookie *msg, upb_Arena *arena,
                                    size_t *len) {
    char *ptr;
...
UPB_INLINE char *
envoy_type_http_v3_Cookie_serialize_ex(const envoy_type_http_v3_Cookie *msg, int options,
...
envoy_type_http_v3_Cookie_name(const envoy_type_http_v3_Cookie *msg) {
...
envoy_type_http_v3_Cookie_ttl(const envoy_type_http_v3_Cookie *msg) {
...
envoy_type_http_v3_Cookie_path(const envoy_type_http_v3_Cookie *msg) {
    return *UPB_PTR_AT(msg, UPB_SIZE(16, 32), upb_StringView);
}

UPB_INLINE void envoy_type_http_v3_Cookie_set_name(envoy_type_http_v3_Cookie * msg, upb_StringView
value) {
*
...
envoy_type_http_v3_Cookie_mutable_ttl(envoy_type_http_v3_Cookie * msg, upb_Arena * arena) {
    struct google_protobuf_Duration *sub = (struct google_protobuf_Duration *) envoy_type_http_v3_Cookie_ttl(
            msg);
    if (sub == NULL) {
...
UPB_INLINE void envoy_type_http_v3_Cookie_set_path(envoy_type_http_v3_Cookie * msg, upb_StringView
value) {
*
