...
UPB_INLINE envoy_type_v3_TokenBucket
*
envoy_type_v3_TokenBucket_new(upb_Arena
* arena) {
return (envoy_type_v3_TokenBucket*)
_upb_Message_New(&envoy_type_v3_TokenBucket_msginit, arena
);
}
UPB_INLINE envoy_type_v3_TokenBucket
*

envoy_type_v3_TokenBucket_parse(const char *buf, size_t size, upb_Arena *arena) {
    envoy_type_v3_TokenBucket * ret = envoy_type_v3_TokenBucket_new(arena);
    if (!ret) return NULL;
    if (upb_Decode(buf, size, ret, &envoy_type_v3_TokenBucket_msginit, NULL, 0, arena) !=
...
envoy_type_v3_TokenBucket_parse_ex(const char *buf, size_t size,
...
UPB_INLINE char *
envoy_type_v3_TokenBucket_serialize(const envoy_type_v3_TokenBucket *msg, upb_Arena *arena,
                                    size_t *len) {
    char *ptr;
...
UPB_INLINE char *
envoy_type_v3_TokenBucket_serialize_ex(const envoy_type_v3_TokenBucket *msg, int options,
...
envoy_type_v3_TokenBucket_max_tokens(const envoy_type_v3_TokenBucket *msg) {
    return *UPB_PTR_AT(msg, UPB_SIZE(4, 4), uint32_t);
}

UPB_INLINE bool
envoy_type_v3_TokenBucket_has_tokens_per_fill(const envoy_type_v3_TokenBucket *msg) {
    return _upb_hasbit(msg, 1);
}

UPB_INLINE void
envoy_type_v3_TokenBucket_clear_tokens_per_fill(const envoy_type_v3_TokenBucket *msg) {
    *UPB_PTR_AT(msg, UPB_SIZE(8, 8),
    const upb_Message*) = NULL;
}

UPB_INLINE const struct google_protobuf_UInt32Value *
envoy_type_v3_TokenBucket_tokens_per_fill(const envoy_type_v3_TokenBucket *msg) {
...
UPB_INLINE void
envoy_type_v3_TokenBucket_clear_fill_interval(const envoy_type_v3_TokenBucket *msg) {
    *UPB_PTR_AT(msg, UPB_SIZE(12, 16),
    const upb_Message*) = NULL;
}

UPB_INLINE const struct google_protobuf_Duration *
envoy_type_v3_TokenBucket_fill_interval(const envoy_type_v3_TokenBucket *msg) {
    return *UPB_PTR_AT(msg, UPB_SIZE(12, 16),
    const struct google_protobuf_Duration*);
}

UPB_INLINE void envoy_type_v3_TokenBucket_set_max_tokens(envoy_type_v3_TokenBucket * msg, uint32_t
value) {
*
...
envoy_type_v3_TokenBucket_mutable_tokens_per_fill(envoy_type_v3_TokenBucket * msg,
                                                  upb_Arena * arena) {
    struct google_protobuf_UInt32Value *sub = (struct google_protobuf_UInt32Value *) envoy_type_v3_TokenBucket_tokens_per_fill(
            msg);
    if (sub == NULL) {
...
envoy_type_v3_TokenBucket_mutable_fill_interval(envoy_type_v3_TokenBucket * msg,
                                                upb_Arena * arena) {
    struct google_protobuf_Duration *sub = (struct google_protobuf_Duration *) envoy_type_v3_TokenBucket_fill_interval(
            msg);
    if (sub == NULL) {
