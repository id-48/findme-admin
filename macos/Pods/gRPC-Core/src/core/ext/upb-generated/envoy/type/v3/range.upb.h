...
*
envoy_type_v3_Int64Range_new(upb_Arena
* arena) {
return (envoy_type_v3_Int64Range*)
_upb_Message_New(&envoy_type_v3_Int64Range_msginit, arena
);
}
UPB_INLINE envoy_type_v3_Int64Range
*

envoy_type_v3_Int64Range_parse(const char *buf, size_t size, upb_Arena *arena) {
    envoy_type_v3_Int64Range * ret = envoy_type_v3_Int64Range_new(arena);
    if (!ret) return NULL;
    if (upb_Decode(buf, size, ret, &envoy_type_v3_Int64Range_msginit, NULL, 0, arena) !=
...
envoy_type_v3_Int64Range_parse_ex(const char *buf, size_t size,
...
UPB_INLINE char *
envoy_type_v3_Int64Range_serialize(const envoy_type_v3_Int64Range *msg, upb_Arena *arena,
                                   size_t *len) {
    char *ptr;
...
UPB_INLINE char *
envoy_type_v3_Int64Range_serialize_ex(const envoy_type_v3_Int64Range *msg, int options,
...
envoy_type_v3_Int64Range_start(const envoy_type_v3_Int64Range *msg) {
...
envoy_type_v3_Int64Range_end(const envoy_type_v3_Int64Range *msg) {
    return *UPB_PTR_AT(msg, UPB_SIZE(8, 8), int64_t);
}

UPB_INLINE void envoy_type_v3_Int64Range_set_start(envoy_type_v3_Int64Range * msg, int64_t
value) {
*
...
UPB_INLINE void envoy_type_v3_Int64Range_set_end(envoy_type_v3_Int64Range * msg, int64_t
value) {
*
...
UPB_INLINE envoy_type_v3_Int32Range
*
envoy_type_v3_Int32Range_new(upb_Arena
* arena) {
return (envoy_type_v3_Int32Range*)
_upb_Message_New(&envoy_type_v3_Int32Range_msginit, arena
);
}
UPB_INLINE envoy_type_v3_Int32Range
*

envoy_type_v3_Int32Range_parse(const char *buf, size_t size, upb_Arena *arena) {
    envoy_type_v3_Int32Range * ret = envoy_type_v3_Int32Range_new(arena);
    if (!ret) return NULL;
    if (upb_Decode(buf, size, ret, &envoy_type_v3_Int32Range_msginit, NULL, 0, arena) !=
        kUpb_DecodeStatus_Ok) {
        return NULL;
    }
    return ret;
...
envoy_type_v3_Int32Range_parse_ex(const char *buf, size_t size,
                                  const upb_ExtensionRegistry *extreg,
                                  int options, upb_Arena *arena) {
    envoy_type_v3_Int32Range * ret = envoy_type_v3_Int32Range_new(arena);
    if (!ret) return NULL;
...
UPB_INLINE char *
envoy_type_v3_Int32Range_serialize(const envoy_type_v3_Int32Range *msg, upb_Arena *arena,
                                   size_t *len) {
    char *ptr;
...
UPB_INLINE char *
envoy_type_v3_Int32Range_serialize_ex(const envoy_type_v3_Int32Range *msg, int options,
                                      upb_Arena *arena, size_t *len) {
    char *ptr;
...
envoy_type_v3_Int32Range_start(const envoy_type_v3_Int32Range *msg) {
...
UPB_INLINE void envoy_type_v3_Int32Range_set_start(envoy_type_v3_Int32Range * msg, int32_t
value) {
*
...
UPB_INLINE void envoy_type_v3_Int32Range_set_end(envoy_type_v3_Int32Range * msg, int32_t
value) {
*
...
UPB_INLINE envoy_type_v3_DoubleRange
*
envoy_type_v3_DoubleRange_new(upb_Arena
* arena) {
return (envoy_type_v3_DoubleRange*)
_upb_Message_New(&envoy_type_v3_DoubleRange_msginit, arena
);
}
UPB_INLINE envoy_type_v3_DoubleRange
*

envoy_type_v3_DoubleRange_parse(const char *buf, size_t size, upb_Arena *arena) {
    envoy_type_v3_DoubleRange * ret = envoy_type_v3_DoubleRange_new(arena);
    if (!ret) return NULL;
    if (upb_Decode(buf, size, ret, &envoy_type_v3_DoubleRange_msginit, NULL, 0, arena) !=
        kUpb_DecodeStatus_Ok) {
        return NULL;
    }
    return ret;
...
envoy_type_v3_DoubleRange_parse_ex(const char *buf, size_t size,
                                   const upb_ExtensionRegistry *extreg,
                                   int options, upb_Arena *arena) {
    envoy_type_v3_DoubleRange * ret = envoy_type_v3_DoubleRange_new(arena);
    if (!ret) return NULL;
...
UPB_INLINE char *
envoy_type_v3_DoubleRange_serialize(const envoy_type_v3_DoubleRange *msg, upb_Arena *arena,
                                    size_t *len) {
    char *ptr;
...
UPB_INLINE char *
envoy_type_v3_DoubleRange_serialize_ex(const envoy_type_v3_DoubleRange *msg, int options,
                                       upb_Arena *arena, size_t *len) {
    char *ptr;
...
UPB_INLINE void envoy_type_v3_DoubleRange_set_start(envoy_type_v3_DoubleRange * msg, double
value) {
*
...
UPB_INLINE void envoy_type_v3_DoubleRange_set_end(envoy_type_v3_DoubleRange * msg, double
value) {
*
