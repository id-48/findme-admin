...
static const upb_MiniTable_Field envoy_config_listener_v3_UdpListenerConfig__fields[3] = {
        {5, UPB_SIZE(4, 8),   UPB_SIZE(1, 1), 0, 11,
                                                     kUpb_FieldMode_Scalar | (kUpb_FieldRep_Pointer
                                                             << kUpb_FieldRep_Shift)},
        {7, UPB_SIZE(8, 16),  UPB_SIZE(2, 2), 1, 11, kUpb_FieldMode_Scalar | (kUpb_FieldRep_Pointer
                << kUpb_FieldRep_Shift)},
        {8, UPB_SIZE(12, 24), UPB_SIZE(3, 3), 2, 11, kUpb_FieldMode_Scalar | (kUpb_FieldRep_Pointer
                << kUpb_FieldRep_Shift)},
};
