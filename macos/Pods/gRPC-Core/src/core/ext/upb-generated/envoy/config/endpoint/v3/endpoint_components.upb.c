...
static const upb_MiniTable_Field envoy_config_endpoint_v3_LbEndpoint__fields[5] = {
        {1, UPB_SIZE(12, 16), UPB_SIZE(-9, -9), 0,          11,
                                                                kUpb_FieldMode_Scalar |
                                                                (kUpb_FieldRep_Pointer
                                                                        << kUpb_FieldRep_Shift)},
        {2, UPB_SIZE(4, 4),   UPB_SIZE(0, 0),   kUpb_NoSub, 5,  kUpb_FieldMode_Scalar |
                                                                (kUpb_FieldRep_4Byte
                                                                        << kUpb_FieldRep_Shift)},
        {3, UPB_SIZE(20, 32), UPB_SIZE(1, 1),   1,          11, kUpb_FieldMode_Scalar |
                                                                (kUpb_FieldRep_Pointer
                                                                        << kUpb_FieldRep_Shift)},
        {4, UPB_SIZE(24, 40), UPB_SIZE(2, 2),   2,          11, kUpb_FieldMode_Scalar |
                                                                (kUpb_FieldRep_Pointer
                                                                        << kUpb_FieldRep_Shift)},
        {5, UPB_SIZE(12, 16), UPB_SIZE(-9, -9), kUpb_NoSub, 9,  kUpb_FieldMode_Scalar |
                                                                (kUpb_FieldRep_StringView
                                                                        << kUpb_FieldRep_Shift)},
};
...
static const upb_MiniTable_Field envoy_config_endpoint_v3_LocalityLbEndpoints__fields[7] = {
        ...
        {5, UPB_SIZE(4, 4),   UPB_SIZE(0, 0),   kUpb_NoSub, 13, kUpb_FieldMode_Scalar |
                                                                (kUpb_FieldRep_4Byte
                                                                        << kUpb_FieldRep_Shift)},
        {6, UPB_SIZE(24, 40), UPB_SIZE(3, 3),   3,          11, kUpb_FieldMode_Scalar |
                                                                (kUpb_FieldRep_Pointer
                                                                        << kUpb_FieldRep_Shift)},
        {7, UPB_SIZE(28, 48), UPB_SIZE(-9, -9), 4,          11, kUpb_FieldMode_Scalar |
                                                                (kUpb_FieldRep_Pointer
                                                                        << kUpb_FieldRep_Shift)},
        {8, UPB_SIZE(28, 48), UPB_SIZE(-9, -9), 5,          11, kUpb_FieldMode_Scalar |
                                                                (kUpb_FieldRep_Pointer
                                                                        << kUpb_FieldRep_Shift)},
};
