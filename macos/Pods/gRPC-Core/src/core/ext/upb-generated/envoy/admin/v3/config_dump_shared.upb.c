...
static const upb_MiniTable_Field envoy_admin_v3_ListenersConfigDump_DynamicListener__fields[6] = {
        ...
        {3, UPB_SIZE(20, 32), UPB_SIZE(2, 2), 1,          11, kUpb_FieldMode_Scalar |
                                                              (kUpb_FieldRep_Pointer
                                                                      << kUpb_FieldRep_Shift)},
        {4, UPB_SIZE(24, 40), UPB_SIZE(3, 3), 2,          11, kUpb_FieldMode_Scalar |
                                                              (kUpb_FieldRep_Pointer
                                                                      << kUpb_FieldRep_Shift)},
        {5, UPB_SIZE(28, 48), UPB_SIZE(4, 4), 3,          11, kUpb_FieldMode_Scalar |
                                                              (kUpb_FieldRep_Pointer
                                                                      << kUpb_FieldRep_Shift)},
...
static const upb_MiniTable_Field envoy_admin_v3_ClustersConfigDump__fields[4] = {
        ...
        {3, UPB_SIZE(12, 24), UPB_SIZE(0, 0), 1,          11, kUpb_FieldMode_Array |
                                                              (kUpb_FieldRep_Pointer
                                                                      << kUpb_FieldRep_Shift)},
        {4, UPB_SIZE(16, 32), UPB_SIZE(0, 0), 2,          11, kUpb_FieldMode_Array |
                                                              (kUpb_FieldRep_Pointer
                                                                      << kUpb_FieldRep_Shift)},
};
...
static const upb_MiniTable_Field envoy_admin_v3_RoutesConfigDump__fields[2] = {
        {2, UPB_SIZE(0, 0), UPB_SIZE(0, 0), 0, 11,
                                                   ...
                                                   (kUpb_FieldRep_Pointer << kUpb_FieldRep_Shift)},
        {3, UPB_SIZE(4, 8), UPB_SIZE(0, 0), 1, 11, kUpb_FieldMode_Array |
                                                   (kUpb_FieldRep_Pointer << kUpb_FieldRep_Shift)},
};
...
static const upb_MiniTable_Field envoy_admin_v3_ScopedRoutesConfigDump_DynamicScopedRouteConfigs__fields[6] = {
        ...
        {3, UPB_SIZE(24, 40), UPB_SIZE(0, 0), 0,          11, kUpb_FieldMode_Array |
                                                              (kUpb_FieldRep_Pointer
                                                                      << kUpb_FieldRep_Shift)},
        {4, UPB_SIZE(28, 48), UPB_SIZE(1, 1), 1,          11, kUpb_FieldMode_Scalar |
                                                              (kUpb_FieldRep_Pointer
                                                                      << kUpb_FieldRep_Shift)},
        {5, UPB_SIZE(32, 56), UPB_SIZE(2, 2), 2,          11, kUpb_FieldMode_Scalar |
                                                              (kUpb_FieldRep_Pointer
                                                                      << kUpb_FieldRep_Shift)},
        {6, UPB_SIZE(4, 4),   UPB_SIZE(0, 0), kUpb_NoSub, 5,  kUpb_FieldMode_Scalar |
                                                              (kUpb_FieldRep_4Byte
