...
static const upb_MiniTable_Field envoy_config_endpoint_v3_ClusterLoadAssignment__fields[4] = {
        ...
        {4, UPB_SIZE(16, 32), UPB_SIZE(1, 1), 1,          11, kUpb_FieldMode_Scalar |
                                                              (kUpb_FieldRep_Pointer
                                                                      << kUpb_FieldRep_Shift)},
        {5, UPB_SIZE(20, 40), UPB_SIZE(0, 0), 2,          11, kUpb_FieldMode_Map |
                                                              (kUpb_FieldRep_Pointer
                                                                      << kUpb_FieldRep_Shift)},
};
...
static const upb_MiniTable_Field envoy_config_endpoint_v3_ClusterLoadAssignment_Policy__fields[3] = {
        {2, UPB_SIZE(4, 8),   UPB_SIZE(0, 0), 0, 11,
                                                     kUpb_FieldMode_Array | (kUpb_FieldRep_Pointer
                                                             << kUpb_FieldRep_Shift)},
        {3, UPB_SIZE(8, 16),  UPB_SIZE(1, 1), 1, 11, kUpb_FieldMode_Scalar | (kUpb_FieldRep_Pointer
                << kUpb_FieldRep_Shift)},
        {4, UPB_SIZE(12, 24), UPB_SIZE(2, 2), 2, 11, kUpb_FieldMode_Scalar | (kUpb_FieldRep_Pointer
                << kUpb_FieldRep_Shift)},
};
