...
UPB_INLINE envoy_admin_v3_TapRequest
*
envoy_admin_v3_TapRequest_new(upb_Arena
* arena) {
return (envoy_admin_v3_TapRequest*)
_upb_Message_New(&envoy_admin_v3_TapRequest_msginit, arena
);
}
UPB_INLINE envoy_admin_v3_TapRequest
*

envoy_admin_v3_TapRequest_parse(const char *buf, size_t size, upb_Arena *arena) {
    envoy_admin_v3_TapRequest * ret = envoy_admin_v3_TapRequest_new(arena);
    if (!ret) return NULL;
    if (upb_Decode(buf, size, ret, &envoy_admin_v3_TapRequest_msginit, NULL, 0, arena) !=
...
envoy_admin_v3_TapRequest_parse_ex(const char *buf, size_t size,
...
UPB_INLINE char *
envoy_admin_v3_TapRequest_serialize(const envoy_admin_v3_TapRequest *msg, upb_Arena *arena,
                                    size_t *len) {
    char *ptr;
...
UPB_INLINE char *
envoy_admin_v3_TapRequest_serialize_ex(const envoy_admin_v3_TapRequest *msg, int options,
...
envoy_admin_v3_TapRequest_config_id(const envoy_admin_v3_TapRequest *msg) {
...
UPB_INLINE const struct envoy_config_tap_v3_TapConfig *
envoy_admin_v3_TapRequest_tap_config(const envoy_admin_v3_TapRequest *msg) {
    return *UPB_PTR_AT(msg, UPB_SIZE(12, 24),
    const struct envoy_config_tap_v3_TapConfig*);
}

UPB_INLINE void envoy_admin_v3_TapRequest_set_config_id(envoy_admin_v3_TapRequest * msg,
                                                        upb_StringView
value) {
*
...
UPB_INLINE void envoy_admin_v3_TapRequest_set_tap_config(envoy_admin_v3_TapRequest * msg,
struct envoy_config_tap_v3_TapConfig *value
) {
_upb_sethas(msg,
1);
*
...
UPB_INLINE struct envoy_config_tap_v3_TapConfig *
envoy_admin_v3_TapRequest_mutable_tap_config(envoy_admin_v3_TapRequest * msg, upb_Arena * arena) {
    struct envoy_config_tap_v3_TapConfig *sub = (struct envoy_config_tap_v3_TapConfig *) envoy_admin_v3_TapRequest_tap_config(
            msg);
    if (sub == NULL) {
        sub = (struct envoy_config_tap_v3_TapConfig *) _upb_Message_New(
                &envoy_config_tap_v3_TapConfig_msginit, arena);
        if (!sub) return NULL;
