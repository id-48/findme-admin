...
static const upb_MiniTable_Field envoy_config_metrics_v3_StatsConfig__fields[4] = {
        {1, UPB_SIZE(4, 8),   UPB_SIZE(0, 0), 0, 11,
                                                     kUpb_FieldMode_Array | (kUpb_FieldRep_Pointer
                                                             << kUpb_FieldRep_Shift)},
        {2, UPB_SIZE(8, 16),  UPB_SIZE(1, 1), 1, 11, kUpb_FieldMode_Scalar | (kUpb_FieldRep_Pointer
                << kUpb_FieldRep_Shift)},
        {3, UPB_SIZE(12, 24), UPB_SIZE(2, 2), 2, 11, kUpb_FieldMode_Scalar | (kUpb_FieldRep_Pointer
                << kUpb_FieldRep_Shift)},
...
static const upb_MiniTable_Field envoy_config_metrics_v3_StatsMatcher__fields[3] = {
        {1, UPB_SIZE(4, 8), UPB_SIZE(-1, -1), kUpb_NoSub, 8,
                                                              kUpb_FieldMode_Scalar |
                                                              (kUpb_FieldRep_1Byte
                                                                      << kUpb_FieldRep_Shift)},
        {2, UPB_SIZE(4, 8), UPB_SIZE(-1, -1), 0,          11, kUpb_FieldMode_Scalar |
                                                              (kUpb_FieldRep_Pointer
                                                                      << kUpb_FieldRep_Shift)},
        {3, UPB_SIZE(4, 8), UPB_SIZE(-1, -1), 1,          11, kUpb_FieldMode_Scalar |
                                                              (kUpb_FieldRep_Pointer
                                                                      << kUpb_FieldRep_Shift)},
};
...
static const upb_MiniTable_Field envoy_config_metrics_v3_HistogramBucketSettings__fields[2] = {
        {1, UPB_SIZE(4, 8),  UPB_SIZE(1, 1), 0,          11,
                                                            ...
                                                            (kUpb_FieldRep_Pointer
                                                                    << kUpb_FieldRep_Shift)},
        {2, UPB_SIZE(8, 16), UPB_SIZE(0, 0), kUpb_NoSub, 1, kUpb_FieldMode_Array |
...
static const upb_MiniTable_Field envoy_config_metrics_v3_DogStatsdSink__fields[3] = {
        {1, UPB_SIZE(20, 32), UPB_SIZE(-5, -5), 0,          11,
                                                                kUpb_FieldMode_Scalar |
                                                                (kUpb_FieldRep_Pointer
                                                                        << kUpb_FieldRep_Shift)},
        {3, UPB_SIZE(8, 8),   UPB_SIZE(0, 0),   kUpb_NoSub, 9,  kUpb_FieldMode_Scalar |
                                                                (kUpb_FieldRep_StringView
                                                                        << kUpb_FieldRep_Shift)},
