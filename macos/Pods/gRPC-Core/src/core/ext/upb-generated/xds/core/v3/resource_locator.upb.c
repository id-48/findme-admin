...
static const upb_MiniTable_Field xds_core_v3_ResourceLocator__fields[6] = {
        {1, UPB_SIZE(0, 0),   UPB_SIZE(0, 0),   kUpb_NoSub, 5,
                                                                ...
                                                                (kUpb_FieldRep_4Byte
                                                                        << kUpb_FieldRep_Shift)},
        {2, UPB_SIZE(8, 8),   UPB_SIZE(0, 0),   kUpb_NoSub, 9,  kUpb_FieldMode_Scalar |
        ...
        {4, UPB_SIZE(24, 40), UPB_SIZE(0, 0),   kUpb_NoSub, 9,  kUpb_FieldMode_Scalar |
                                                                (kUpb_FieldRep_StringView
                                                                        << kUpb_FieldRep_Shift)},
        {5, UPB_SIZE(36, 64), UPB_SIZE(-5, -5), 0,          11, kUpb_FieldMode_Scalar |
                                                                (kUpb_FieldRep_Pointer
                                                                        << kUpb_FieldRep_Shift)},
        {6, UPB_SIZE(32, 56), UPB_SIZE(0, 0),   1,          11, kUpb_FieldMode_Array |
                                                                (kUpb_FieldRep_Pointer
                                                                        << kUpb_FieldRep_Shift)},
};
