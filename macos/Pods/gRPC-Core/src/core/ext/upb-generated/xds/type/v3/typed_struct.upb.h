...
UPB_INLINE xds_type_v3_TypedStruct
*
xds_type_v3_TypedStruct_new(upb_Arena
* arena) {
return (xds_type_v3_TypedStruct*)
_upb_Message_New(&xds_type_v3_TypedStruct_msginit, arena
);
}
UPB_INLINE xds_type_v3_TypedStruct
*

xds_type_v3_TypedStruct_parse(const char *buf, size_t size, upb_Arena *arena) {
    xds_type_v3_TypedStruct * ret = xds_type_v3_TypedStruct_new(arena);
    if (!ret) return NULL;
    if (upb_Decode(buf, size, ret, &xds_type_v3_TypedStruct_msginit, NULL, 0, arena) !=
...
xds_type_v3_TypedStruct_parse_ex(const char *buf, size_t size,
...
UPB_INLINE char *
xds_type_v3_TypedStruct_serialize(const xds_type_v3_TypedStruct *msg, upb_Arena *arena,
                                  size_t *len) {
    char *ptr;
...
UPB_INLINE char *
xds_type_v3_TypedStruct_serialize_ex(const xds_type_v3_TypedStruct *msg, int options,
...
xds_type_v3_TypedStruct_type_url(const xds_type_v3_TypedStruct *msg) {
...
xds_type_v3_TypedStruct_value(const xds_type_v3_TypedStruct *msg) {
    return *UPB_PTR_AT(msg, UPB_SIZE(12, 24),
    const struct google_protobuf_Struct*);
}

UPB_INLINE void xds_type_v3_TypedStruct_set_type_url(xds_type_v3_TypedStruct * msg, upb_StringView
value) {
*
...
xds_type_v3_TypedStruct_mutable_value(xds_type_v3_TypedStruct * msg, upb_Arena * arena) {
    struct google_protobuf_Struct *sub = (struct google_protobuf_Struct *) xds_type_v3_TypedStruct_value(
            msg);
    if (sub == NULL) {
