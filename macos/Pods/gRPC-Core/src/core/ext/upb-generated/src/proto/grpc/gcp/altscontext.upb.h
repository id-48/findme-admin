...
UPB_INLINE grpc_gcp_AltsContext
*
grpc_gcp_AltsContext_new(upb_Arena
* arena) {
return (grpc_gcp_AltsContext*)
_upb_Message_New(&grpc_gcp_AltsContext_msginit, arena
);
}
UPB_INLINE grpc_gcp_AltsContext
*

grpc_gcp_AltsContext_parse(const char *buf, size_t size, upb_Arena *arena) {
    grpc_gcp_AltsContext * ret = grpc_gcp_AltsContext_new(arena);
    if (!ret) return NULL;
    if (upb_Decode(buf, size, ret, &grpc_gcp_AltsContext_msginit, NULL, 0, arena) !=
...
grpc_gcp_AltsContext_parse_ex(const char *buf, size_t size,
...
UPB_INLINE char *
grpc_gcp_AltsContext_serialize(const grpc_gcp_AltsContext *msg, upb_Arena *arena, size_t *len) {
    char *ptr;
...
grpc_gcp_AltsContext_application_protocol(const grpc_gcp_AltsContext *msg) {
...
grpc_gcp_AltsContext_record_protocol(const grpc_gcp_AltsContext *msg) {
...
grpc_gcp_AltsContext_security_level(const grpc_gcp_AltsContext *msg) {
...
grpc_gcp_AltsContext_peer_service_account(const grpc_gcp_AltsContext *msg) {
...
grpc_gcp_AltsContext_local_service_account(const grpc_gcp_AltsContext *msg) {
...
grpc_gcp_AltsContext_peer_rpc_versions(const grpc_gcp_AltsContext *msg) {
...
grpc_gcp_AltsContext_peer_attributes_size(const grpc_gcp_AltsContext *msg) {
    return _upb_msg_map_size(msg, UPB_SIZE(44, 80));
}

UPB_INLINE bool
grpc_gcp_AltsContext_peer_attributes_get(const grpc_gcp_AltsContext *msg, upb_StringView key,
                                         upb_StringView *val) {
    return _upb_msg_map_get(msg, UPB_SIZE(44, 80), &key, 0, val, 0);
}

UPB_INLINE const grpc_gcp_AltsContext_PeerAttributesEntry
*

grpc_gcp_AltsContext_peer_attributes_next(const grpc_gcp_AltsContext *msg, size_t *iter) {
    return (const grpc_gcp_AltsContext_PeerAttributesEntry *) _upb_msg_map_next(msg,
                                                                                UPB_SIZE(44, 80),
                                                                                iter);
}
...
UPB_INLINE void grpc_gcp_AltsContext_set_record_protocol(grpc_gcp_AltsContext * msg, upb_StringView
value) {
*
...
UPB_INLINE void grpc_gcp_AltsContext_set_security_level(grpc_gcp_AltsContext * msg, int32_t
value) {
*
...
grpc_gcp_AltsContext_mutable_peer_rpc_versions(grpc_gcp_AltsContext * msg, upb_Arena * arena) {
    struct grpc_gcp_RpcProtocolVersions *sub = (struct grpc_gcp_RpcProtocolVersions *) grpc_gcp_AltsContext_peer_rpc_versions(
            msg);
    if (sub == NULL) {
...
UPB_INLINE void
grpc_gcp_AltsContext_peer_attributes_clear(grpc_gcp_AltsContext * msg) { _upb_msg_map_clear(msg,
                                                                                            UPB_SIZE(
                                                                                                    44,
                                                                                                    80));
}

UPB_INLINE bool grpc_gcp_AltsContext_peer_attributes_set(grpc_gcp_AltsContext * msg, upb_StringView
key,
upb_StringView val, upb_Arena
* a) {
return
_upb_msg_map_set(msg, UPB_SIZE(44, 80), &key,
0, &val, 0, a);
}
...
key) {
return
_upb_msg_map_delete(msg, UPB_SIZE(44, 80), &key,
0);
}
UPB_INLINE grpc_gcp_AltsContext_PeerAttributesEntry
*
grpc_gcp_AltsContext_peer_attributes_nextmutable(grpc_gcp_AltsContext
* msg,
size_t *iter
) {
return (grpc_gcp_AltsContext_PeerAttributesEntry*)
...
grpc_gcp_AltsContext_PeerAttributesEntry_key(const grpc_gcp_AltsContext_PeerAttributesEntry *msg) {
    upb_StringView ret;
...
grpc_gcp_AltsContext_PeerAttributesEntry_value(
        const grpc_gcp_AltsContext_PeerAttributesEntry *msg) {
    upb_StringView ret;
    _upb_msg_map_value(msg, &ret, 0);
    return ret;
}

UPB_INLINE void grpc_gcp_AltsContext_PeerAttributesEntry_set_value(
        grpc_gcp_AltsContext_PeerAttributesEntry * msg, upb_StringView
value) {
