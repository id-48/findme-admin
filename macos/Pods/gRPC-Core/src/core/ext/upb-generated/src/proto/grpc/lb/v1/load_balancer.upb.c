...
static const upb_MiniTable_Field grpc_lb_v1_ClientStatsPerToken__fields[2] = {
        {1, UPB_SIZE(0, 0),  UPB_SIZE(0, 0), kUpb_NoSub, 9,
                                                            ...
                                                            (kUpb_FieldRep_StringView
                                                                    << kUpb_FieldRep_Shift)},
        {2, UPB_SIZE(8, 16), UPB_SIZE(0, 0), kUpb_NoSub, 3, kUpb_FieldMode_Scalar |
                                                            (kUpb_FieldRep_8Byte
                                                                    << kUpb_FieldRep_Shift)},
};
...
static const upb_MiniTable_Field grpc_lb_v1_ClientStats__fields[6] = {
        {1, UPB_SIZE(4, 8),   UPB_SIZE(1, 1), 0,          11,
                                                              ...
                                                              (kUpb_FieldRep_Pointer
                                                                      << kUpb_FieldRep_Shift)},
        {2, UPB_SIZE(16, 24), UPB_SIZE(0, 0), kUpb_NoSub, 3,  kUpb_FieldMode_Scalar |
                                                              (kUpb_FieldRep_8Byte
                                                                      << kUpb_FieldRep_Shift)},
        {3, UPB_SIZE(24, 32), UPB_SIZE(0, 0), kUpb_NoSub, 3,  kUpb_FieldMode_Scalar |
                                                              (kUpb_FieldRep_8Byte
                                                                      << kUpb_FieldRep_Shift)},
        {6, UPB_SIZE(32, 40), UPB_SIZE(0, 0), kUpb_NoSub, 3,  kUpb_FieldMode_Scalar |
                                                              (kUpb_FieldRep_8Byte
                                                                      << kUpb_FieldRep_Shift)},
        {7, UPB_SIZE(40, 48), UPB_SIZE(0, 0), kUpb_NoSub, 3,  kUpb_FieldMode_Scalar |
                                                              (kUpb_FieldRep_8Byte
                                                                      << kUpb_FieldRep_Shift)},
        {8, UPB_SIZE(8, 16),  UPB_SIZE(0, 0), 1,          11, kUpb_FieldMode_Array |
                                                              (kUpb_FieldRep_Pointer
                                                                      << kUpb_FieldRep_Shift)},
};
