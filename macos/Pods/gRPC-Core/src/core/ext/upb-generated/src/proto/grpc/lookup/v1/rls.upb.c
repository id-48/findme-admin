...
static const upb_MiniTable_Field grpc_lookup_v1_RouteLookupRequest__fields[4] = {
        {3, UPB_SIZE(4, 8),   UPB_SIZE(0, 0), kUpb_NoSub, 9,
                                                              kUpb_FieldMode_Scalar |
                                                              (kUpb_FieldRep_StringView
                                                                      << kUpb_FieldRep_Shift)},
        {4, UPB_SIZE(12, 24), UPB_SIZE(0, 0), 0,          11, kUpb_FieldMode_Map |
                                                              (kUpb_FieldRep_Pointer
                                                                      << kUpb_FieldRep_Shift)},
        {5, UPB_SIZE(0, 0),   UPB_SIZE(0, 0), kUpb_NoSub, 5,  kUpb_FieldMode_Scalar |
                                                              (kUpb_FieldRep_4Byte
                                                                      << kUpb_FieldRep_Shift)},
        {6, UPB_SIZE(16, 32), UPB_SIZE(0, 0), kUpb_NoSub, 9,  kUpb_FieldMode_Scalar |
                                                              (kUpb_FieldRep_StringView
                                                                      << kUpb_FieldRep_Shift)},
};
...
static const upb_MiniTable_Field grpc_lookup_v1_RouteLookupResponse__fields[2] = {
        {2, UPB_SIZE(0, 0),  UPB_SIZE(0, 0), kUpb_NoSub, 9,
                                                            ...
                                                            (kUpb_FieldRep_StringView
                                                                    << kUpb_FieldRep_Shift)},
        {3, UPB_SIZE(8, 16), UPB_SIZE(0, 0), kUpb_NoSub, 9, kUpb_FieldMode_Array |
                                                            (kUpb_FieldRep_Pointer
                                                                    << kUpb_FieldRep_Shift)},
};
