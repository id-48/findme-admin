...
static const upb_MiniTable_Field google_api_HttpRule__fields[10] = {
        ...
        {4,  UPB_SIZE(4, 8),   UPB_SIZE(-1, -1), kUpb_NoSub, 9,  kUpb_FieldMode_Scalar |
                                                                 (kUpb_FieldRep_StringView
                                                                         << kUpb_FieldRep_Shift)},
        {5,  UPB_SIZE(4, 8),   UPB_SIZE(-1, -1), kUpb_NoSub, 9,  kUpb_FieldMode_Scalar |
                                                                 (kUpb_FieldRep_StringView
                                                                         << kUpb_FieldRep_Shift)},
        {6,  UPB_SIZE(4, 8),   UPB_SIZE(-1, -1), kUpb_NoSub, 9,  kUpb_FieldMode_Scalar |
                                                                 (kUpb_FieldRep_StringView
                                                                         << kUpb_FieldRep_Shift)},
        {7,  UPB_SIZE(20, 40), UPB_SIZE(0, 0),   kUpb_NoSub, 9,  kUpb_FieldMode_Scalar |
                                                                 (kUpb_FieldRep_StringView
                                                                         << kUpb_FieldRep_Shift)},
        {8,  UPB_SIZE(4, 8),   UPB_SIZE(-1, -1), 0,          11, kUpb_FieldMode_Scalar |
                                                                 (kUpb_FieldRep_Pointer
                                                                         << kUpb_FieldRep_Shift)},
        {11, UPB_SIZE(28, 56), UPB_SIZE(0, 0),   1,          11, kUpb_FieldMode_Array |
                                                                 (kUpb_FieldRep_Pointer
                                                                         << kUpb_FieldRep_Shift)},
        {12, UPB_SIZE(32, 64), UPB_SIZE(0, 0),   kUpb_NoSub, 9,  kUpb_FieldMode_Scalar |
                                                                 (kUpb_FieldRep_StringView
                                                                         << kUpb_FieldRep_Shift)},
};
