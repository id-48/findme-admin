...
UPB_INLINE google_protobuf_Timestamp
*
google_protobuf_Timestamp_new(upb_Arena
* arena) {
return (google_protobuf_Timestamp*)
_upb_Message_New(&google_protobuf_Timestamp_msginit, arena
);
}
UPB_INLINE google_protobuf_Timestamp
*

google_protobuf_Timestamp_parse(const char *buf, size_t size, upb_Arena *arena) {
    google_protobuf_Timestamp * ret = google_protobuf_Timestamp_new(arena);
    if (!ret) return NULL;
    if (upb_Decode(buf, size, ret, &google_protobuf_Timestamp_msginit, NULL, 0, arena) !=
...
google_protobuf_Timestamp_parse_ex(const char *buf, size_t size,
...
UPB_INLINE char *
google_protobuf_Timestamp_serialize(const google_protobuf_Timestamp *msg, upb_Arena *arena,
                                    size_t *len) {
    char *ptr;
...
UPB_INLINE char *
google_protobuf_Timestamp_serialize_ex(const google_protobuf_Timestamp *msg, int options,
...
UPB_INLINE void google_protobuf_Timestamp_set_seconds(google_protobuf_Timestamp * msg, int64_t
value) {
*
...
UPB_INLINE void google_protobuf_Timestamp_set_nanos(google_protobuf_Timestamp * msg, int32_t
value) {
*
