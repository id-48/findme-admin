...
UPB_INLINE google_rpc_Status
*
google_rpc_Status_new(upb_Arena
* arena) {
return (google_rpc_Status*)
_upb_Message_New(&google_rpc_Status_msginit, arena
);
}
UPB_INLINE google_rpc_Status
*

google_rpc_Status_parse(const char *buf, size_t size, upb_Arena *arena) {
    google_rpc_Status * ret = google_rpc_Status_new(arena);
    if (!ret) return NULL;
    if (upb_Decode(buf, size, ret, &google_rpc_Status_msginit, NULL, 0, arena) !=
...
google_rpc_Status_parse_ex(const char *buf, size_t size,
...
UPB_INLINE char *
google_rpc_Status_serialize(const google_rpc_Status *msg, upb_Arena *arena, size_t *len) {
    char *ptr;
...
google_rpc_Status_code(const google_rpc_Status *msg) {
...
google_rpc_Status_message(const google_rpc_Status *msg) {
...
google_rpc_Status_details(const google_rpc_Status *msg, size_t *len) {
    return (const struct google_protobuf_Any *const *) _upb_array_accessor(msg, UPB_SIZE(12, 24),
                                                                           len);
}

UPB_INLINE void google_rpc_Status_set_code(google_rpc_Status * msg, int32_t
value) {
*
...
UPB_INLINE void google_rpc_Status_set_message(google_rpc_Status * msg, upb_StringView
value) {
*
...
google_rpc_Status_mutable_details(google_rpc_Status * msg, size_t * len) {
    return (struct google_protobuf_Any **) _upb_array_mutable_accessor(msg, UPB_SIZE(12, 24), len);
}

UPB_INLINE struct google_protobuf_Any **google_rpc_Status_resize_details(google_rpc_Status * msg,
                                                                         size_t
len,
upb_Arena *arena
) {
...
UPB_INLINE struct google_protobuf_Any *
google_rpc_Status_add_details(google_rpc_Status * msg, upb_Arena * arena) {
