...
namespace grpc_core {
    ...
    private:
        ...
        private:
            ...
            ABSL_EXCLUSIVE_LOCKS_REQUIRED(*chand_
            ->work_serializer_);
        ...
        ABSL_GUARDED_BY(resolution_mu_);
        bool received_service_config_data_
        ABSL_GUARDED_BY(resolution_mu_) = false;
        ...
        LbQueuedCall *lb_queued_calls_
        ABSL_GUARDED_BY(data_plane_mu_) = nullptr;
        ...
        ABSL_GUARDED_BY(*work_serializer_);
        int keepalive_time_
        ABSL_GUARDED_BY(*work_serializer_) = -1;
        grpc_error_handle disconnect_error_
        ABSL_GUARDED_BY(*work_serializer_) =
                GRPC_ERROR_NONE;
        ...
        //
        Mutex info_mu_;
        std::string info_lb_policy_name_
        ABSL_GUARDED_BY(info_mu_);
        std::string info_service_config_json_
        ABSL_GUARDED_BY(info_mu_);
