...
*
xds_annotations_v3_MigrateAnnotation_getmsgdef(upb_DefPool
*s) {
...
UPB_INLINE const upb_MessageDef
*
xds_annotations_v3_FieldMigrateAnnotation_getmsgdef(upb_DefPool
*s) {
_upb_DefPool_LoadDefInit(s, &xds_annotations_v3_migrate_proto_upbdefinit
);
return
...
UPB_INLINE const upb_MessageDef
*
xds_annotations_v3_FileMigrateAnnotation_getmsgdef(upb_DefPool
*s) {
_upb_DefPool_LoadDefInit(s, &xds_annotations_v3_migrate_proto_upbdefinit
);
return
