...
*
xds_annotations_v3_FileStatusAnnotation_getmsgdef(upb_DefPool
*s) {
...
UPB_INLINE const upb_MessageDef
*
xds_annotations_v3_MessageStatusAnnotation_getmsgdef(upb_DefPool
*s) {
_upb_DefPool_LoadDefInit(s, &xds_annotations_v3_status_proto_upbdefinit
);
return
...
UPB_INLINE const upb_MessageDef
*
xds_annotations_v3_FieldStatusAnnotation_getmsgdef(upb_DefPool
*s) {
_upb_DefPool_LoadDefInit(s, &xds_annotations_v3_status_proto_upbdefinit
);
return
...
UPB_INLINE const upb_MessageDef
*
xds_annotations_v3_StatusAnnotation_getmsgdef(upb_DefPool
*s) {
_upb_DefPool_LoadDefInit(s, &xds_annotations_v3_status_proto_upbdefinit
);
return
