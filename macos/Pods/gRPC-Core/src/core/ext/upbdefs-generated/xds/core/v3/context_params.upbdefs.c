...
static const char descriptor[321] = {'\n', ' ', 'x', 'd', 's', '/', 'c', 'o', 'r', 'e', '/', 'v',
                                     ...
                                     '.',
                                     'p', 'r', 'o', 't', 'o', '\"', '\212', '\001', '\n', '\r', 'C',
                                     'o', 'n', 't', 'e', 'x', 't', 'P', 'a', 'r', 'a', 'm', 's',
                                     '\022', '>',
                                     '\n', '\006', 'p', 'a', 'r', 'a', 'm', 's', '\030', '\001',
                                     ' ', '\003', '(', '\013', '2', '&', '.', 'x', 'd', 's', '.',
                                     'c', 'o', 'r', 'e',
                                     '.', 'v', '3', '.', 'C', 'o', 'n', 't', 'e', 'x', 't', 'P',
                                     'a', 'r', 'a', 'm', 's', '.', 'P', 'a', 'r', 'a', 'm', 's',
                                     'E',
                                     'n', 't', 'r', 'y', 'R', '\006', 'p', 'a', 'r', 'a', 'm', 's',
                                     '\032', '9', '\n', '\013', 'P', 'a', 'r', 'a', 'm', 's', 'E',
                                     'n', 't',
                                     'r', 'y', '\022', '\020', '\n', '\003', 'k', 'e', 'y', '\030',
                                     '\001', ' ', '\001', '(', '\t', 'R', '\003', 'k', 'e', 'y',
