...
static const char descriptor[481] = {'\n', '4', 'e', 'n', 'v', 'o', 'y', '/', 'e', 'x', 't', 'e',
                                     ...
                                     'e',
                                     'r', 's', '/', 'a', 'g', 'g', 'r', 'e', 'g', 'a', 't', 'e',
                                     '/', 'v', '3', '/', 'c', 'l', 'u', 's', 't', 'e', 'r', '.',
                                     'p',
                                     'r', 'o', 't', 'o', '\022', '&', 'e', 'n', 'v', 'o', 'y', '.',
                                     'e', 'x', 't', 'e', 'n', 's', 'i', 'o', 'n', 's', '.', 'c',
                                     'l',
                                     'u', 's', 't', 'e', 'r', 's', '.', 'a', 'g', 'g', 'r', 'e',
                                     'g', 'a', 't', 'e', '.', 'v', '3', '\032', '\035', 'u', 'd',
                                     'p', 'a',
                                     ...
                                     'l', 'i',
                                     'd', 'a', 't', 'e', '.', 'p', 'r', 'o', 't', 'o', '\"', 'r',
                                     '\n', '\r', 'C', 'l', 'u', 's', 't', 'e', 'r', 'C', 'o', 'n',
                                     'f',
                                     'i', 'g', '\022', '$', '\n', '\010', 'c', 'l', 'u', 's', 't',
                                     'e', 'r', 's', '\030', '\001', ' ', '\003', '(', '\t', 'B',
                                     '\010', '\372', 'B', '\005',
                                     '\222', '\001', '\002', '\010', '\001', 'R', '\010', 'c', 'l',
                                     'u', 's', 't', 'e', 'r', 's', ':', ';', '\232', '\305', '\210',
                                     '\036', '6', '\n', '4', 'e',
                                     'n', 'v', 'o', 'y', '.', 'c', 'o', 'n', 'f', 'i', 'g', '.',
                                     'c', 'l', 'u', 's', 't', 'e', 'r', '.', 'a', 'g', 'g', 'r',
                                     'e',
                                     'g', 'a', 't', 'e', '.', 'v', '2', 'a', 'l', 'p', 'h', 'a',
                                     '.', 'C', 'l', 'u', 's', 't', 'e', 'r', 'C', 'o', 'n', 'f',
                                     'i',
                                     'g', 'B', '\251', '\001', '\n', '4', 'i', 'o', '.', 'e', 'n',
                                     ...
                                     'r',
                                     'e', 'g', 'a', 't', 'e', '.', 'v', '3', 'B', '\014', 'C', 'l',
                                     'u', 's', 't', 'e', 'r', 'P', 'r', 'o', 't', 'o', 'P', '\001',
                                     'Z',
                                     'Y', 'g', 'i', 't', 'h', 'u', 'b', '.', 'c', 'o', 'm', '/',
