...
static const char descriptor[1018] = {'\n', '\"', 'e', 'n', 'v', 'o', 'y', '/', 'c', 'o', 'n', 'f',
                                      'i', 'g', '/', 't', 'r', 'a', 'c', 'e', '/', 'v', '3', '/',
                                      'z',
                                      'i', 'p', 'k', 'i', 'n', '.', 'p', 'r', 'o', 't', 'o', '\022',
                                      '\025', 'e', 'n', 'v', 'o', 'y', '.', 'c', 'o', 'n', 'f', 'i',
                                      'g',
                                      '.', 't', 'r', 'a', 'c', 'e', '.', 'v', '3', '\032', '\036',
                                      'g', 'o', 'o', 'g', 'l', 'e', '/', 'p', 'r', 'o', 't', 'o',
                                      'b', 'u',
                                      'f', '/', 'w', 'r', 'a', 'p', 'p', 'e', 'r', 's', '.', 'p',
                                      'r', 'o', 't', 'o', '\032', '#', 'e', 'n', 'v', 'o', 'y', '/',
                                      'a',
                                      'n', 'n', 'o', 't', 'a', 't', 'i', 'o', 'n', 's', '/', 'd',
                                      ...
                                      'o', 't',
                                      'o', '\"', '\300', '\004', '\n', '\014', 'Z', 'i', 'p', 'k',
                                      'i', 'n', 'C', 'o', 'n', 'f', 'i', 'g', '\022', '4', '\n',
                                      '\021', 'c', 'o', 'l',
                                      'l', 'e', 'c', 't', 'o', 'r', '_', 'c', 'l', 'u', 's', 't',
                                      'e', 'r', '\030', '\001', ' ', '\001', '(', '\t', 'B', '\007',
                                      '\372', 'B', '\004',
                                      'r', '\002', '\020', '\001', 'R', '\020', 'c', 'o', 'l', 'l',
                                      'e', 'c', 't', 'o', 'r', 'C', 'l', 'u', 's', 't', 'e', 'r',
                                      '\022', '6', '\n',
                                      '\022', 'c', 'o', 'l', 'l', 'e', 'c', 't', 'o', 'r', '_', 'e',
                                      'n', 'd', 'p', 'o', 'i', 'n', 't', '\030', '\002', ' ',
                                      '\001', '(', '\t',
                                      'B', '\007', '\372', 'B', '\004', 'r', '\002', '\020', '\001',
                                      'R', '\021', 'c', 'o', 'l', 'l', 'e', 'c', 't', 'o', 'r', 'E',
                                      'n', 'd', 'p', 'o',
                                      'i', 'n', 't', '\022', '&', '\n', '\017', 't', 'r', 'a', 'c',
                                      'e', '_', 'i', 'd', '_', '1', '2', '8', 'b', 'i', 't', '\030',
                                      '\003', ' ',
                                      '\001', '(', '\010', 'R', '\r', 't', 'r', 'a', 'c', 'e', 'I',
                                      'd', '1', '2', '8', 'b', 'i', 't', '\022', 'J', '\n', '\023',
                                      's', 'h', 'a',
                                      'r', 'e', 'd', '_', 's', 'p', 'a', 'n', '_', 'c', 'o', 'n',
                                      't', 'e', 'x', 't', '\030', '\004', ' ', '\001', '(', '\013',
                                      '2', '\032', '.',
                                      'g', 'o', 'o', 'g', 'l', 'e', '.', 'p', 'r', 'o', 't', 'o',
                                      'b', 'u', 'f', '.', 'B', 'o', 'o', 'l', 'V', 'a', 'l', 'u',
                                      'e',
                                      'R', '\021', 's', 'h', 'a', 'r', 'e', 'd', 'S', 'p', 'a', 'n',
                                      'C', 'o', 'n', 't', 'e', 'x', 't', '\022', 'z', '\n', '\032',
                                      'c', 'o',
                                      'l', 'l', 'e', 'c', 't', 'o', 'r', '_', 'e', 'n', 'd', 'p',
                                      'o', 'i', 'n', 't', '_', 'v', 'e', 'r', 's', 'i', 'o', 'n',
                                      '\030',
                                      '\005', ' ', '\001', '(', '\016', '2', '<', '.', 'e', 'n',
                                      'v', 'o', 'y', '.', 'c', 'o', 'n', 'f', 'i', 'g', '.', 't',
                                      'r', 'a', 'c',
                                      'e', '.', 'v', '3', '.', 'Z', 'i', 'p', 'k', 'i', 'n', 'C',
                                      'o', 'n', 'f', 'i', 'g', '.', 'C', 'o', 'l', 'l', 'e', 'c',
                                      't',
                                      'o', 'r', 'E', 'n', 'd', 'p', 'o', 'i', 'n', 't', 'V', 'e',
                                      'r', 's', 'i', 'o', 'n', 'R', '\030', 'c', 'o', 'l', 'l', 'e',
                                      'c',
                                      't', 'o', 'r', 'E', 'n', 'd', 'p', 'o', 'i', 'n', 't', 'V',
                                      'e', 'r', 's', 'i', 'o', 'n', '\022', '-', '\n', '\022', 'c',
                                      'o', 'l',
                                      'l', 'e', 'c', 't', 'o', 'r', '_', 'h', 'o', 's', 't', 'n',
                                      'a', 'm', 'e', '\030', '\006', ' ', '\001', '(', '\t', 'R',
                                      '\021', 'c', 'o',
                                      ...
                                      'D',
                                      'O', '_', 'N', 'O', 'T', '_', 'U', 'S', 'E', '\020', '\000',
                                      '\032', '\010', '\010', '\001', '\250', '\367', '\264',
                                      '\213', '\002', '\001', '\022', '\r', '\n', '\t',
                                      'H', 'T', 'T', 'P', '_', 'J', 'S', 'O', 'N', '\020', '\001',
                                      '\022', '\016', '\n', '\n', 'H', 'T', 'T', 'P', '_', 'P', 'R',
                                      'O', 'T', 'O',
                                      '\020', '\002', '\022', '\010', '\n', '\004', 'G', 'R', 'P',
                                      ...
                                      '.', 'e',
                                      'n', 'v', 'o', 'y', '.', 'c', 'o', 'n', 'f', 'i', 'g', '.',
                                      't', 'r', 'a', 'c', 'e', '.', 'v', '3', 'B', '\013', 'Z', 'i',
                                      'p',
                                      'k', 'i', 'n', 'P', 'r', 'o', 't', 'o', 'P', '\001', 'Z', 'D',
                                      'g', 'i', 't', 'h', 'u', 'b', '.', 'c', 'o', 'm', '/', 'e',
                                      'n',
                                      'v', 'o', 'y', 'p', 'r', 'o', 'x', 'y', '/', 'g', 'o', '-',
