...
static const char descriptor[534] = {'\n', '\"', 'e', 'n', 'v', 'o', 'y', '/', 'c', 'o', 'n', 'f',
                                     'i', 'g', '/', 'c', 'o', 'r', 'e', '/', 'v', '3', '/', 'b',
                                     'a',
                                     'c', 'k', 'o', 'f', 'f', '.', 'p', 'r', 'o', 't', 'o', '\022',
                                     '\024', 'e', 'n', 'v', 'o', 'y', '.', 'c', 'o', 'n', 'f', 'i',
                                     'g',
                                     '.', 'c', 'o', 'r', 'e', '.', 'v', '3', '\032', '\036', 'g',
                                     ...
                                     'o',
                                     'n', 'B', '\016', '\372', 'B', '\013', '\252', '\001', '\010',
                                     '\010', '\001', '2', '\004', '\020', '\300', '\204', '=', 'R',
                                     '\014', 'b', 'a', 's', 'e', 'I', 'n',
                                     't', 'e', 'r', 'v', 'a', 'l', '\022', 'F', '\n', '\014', 'm',
                                     'a', 'x', '_', 'i', 'n', 't', 'e', 'r', 'v', 'a', 'l', '\030',
                                     '\002', ' ',
                                     ...
                                     '\n', '!', 'e', 'n', 'v', 'o', 'y', '.', 'a', 'p', 'i', '.',
                                     'v', '2', '.',
                                     'c', 'o', 'r', 'e', '.', 'B', 'a', 'c', 'k', 'o', 'f', 'f',
                                     'S', 't', 'r', 'a', 't', 'e', 'g', 'y', 'B', '\200', '\001',
                                     '\n', '\"',
                                     'i', 'o', '.', 'e', 'n', 'v', 'o', 'y', 'p', 'r', 'o', 'x',
                                     'y', '.', 'e', 'n', 'v', 'o', 'y', '.', 'c', 'o', 'n', 'f',
                                     'i',
                                     'g', '.', 'c', 'o', 'r', 'e', '.', 'v', '3', 'B', '\014', 'B',
                                     'a', 'c', 'k', 'o', 'f', 'f', 'P', 'r', 'o', 't', 'o', 'P',
                                     '\001',
