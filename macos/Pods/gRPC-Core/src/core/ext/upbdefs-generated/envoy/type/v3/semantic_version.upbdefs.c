...
static const char descriptor[398] = {'\n', '$', 'e', 'n', 'v', 'o', 'y', '/', 't', 'y', 'p', 'e',
                                     '/', 'v', '3', '/', 's', 'e', 'm', 'a', 'n', 't', 'i', 'c',
                                     '_',
                                     'v', 'e', 'r', 's', 'i', 'o', 'n', '.', 'p', 'r', 'o', 't',
                                     'o', '\022', '\r', 'e', 'n', 'v', 'o', 'y', '.', 't', 'y', 'p',
                                     'e',
                                     '.', 'v', '3', '\032', '\035', 'u', 'd', 'p', 'a', '/', 'a',
                                     ...
                                     'o', 'n', '\022', '!', '\n', '\014', 'm', 'a', 'j', 'o', 'r',
                                     '_', 'n',
                                     'u', 'm', 'b', 'e', 'r', '\030', '\001', ' ', '\001', '(',
                                     '\r', 'R', '\013', 'm', 'a', 'j', 'o', 'r', 'N', 'u', 'm', 'b',
                                     'e', 'r', '\022',
                                     '!', '\n', '\014', 'm', 'i', 'n', 'o', 'r', '_', 'n', 'u', 'm',
                                     'b', 'e', 'r', '\030', '\002', ' ', '\001', '(', '\r', 'R',
                                     '\013', 'm', 'i',
                                     'n', 'o', 'r', 'N', 'u', 'm', 'b', 'e', 'r', '\022', '\024',
                                     '\n', '\005', 'p', 'a', 't', 'c', 'h', '\030', '\003', ' ',
                                     '\001', '(', '\r', 'R',
                                     '\005', 'p', 'a', 't', 'c', 'h', ':', '!', '\232', '\305',
                                     '\210', '\036', '\034', '\n', '\032', 'e', 'n', 'v', 'o', 'y',
                                     '.', 't', 'y', 'p', 'e',
                                     '.', 'S', 'e', 'm', 'a', 'n', 't', 'i', 'c', 'V', 'e', 'r',
                                     's', 'i', 'o', 'n', 'B', 'z', '\n', '\033', 'i', 'o', '.', 'e',
                                     'n',
                                     'v', 'o', 'y', 'p', 'r', 'o', 'x', 'y', '.', 'e', 'n', 'v',
                                     'o', 'y', '.', 't', 'y', 'p', 'e', '.', 'v', '3', 'B', '\024',
                                     'S',
                                     'e', 'm', 'a', 'n', 't', 'i', 'c', 'V', 'e', 'r', 's', 'i',
