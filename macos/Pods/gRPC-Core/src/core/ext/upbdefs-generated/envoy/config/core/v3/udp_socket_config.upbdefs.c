...
static const char descriptor[474] = {'\n', ',', 'e', 'n', 'v', 'o', 'y', '/', 'c', 'o', 'n', 'f',
                                     'i', 'g', '/', 'c', 'o', 'r', 'e', '/', 'v', '3', '/', 'u',
                                     'd',
                                     'p', '_', 's', 'o', 'c', 'k', 'e', 't', '_', 'c', 'o', 'n',
                                     'f', 'i', 'g', '.', 'p', 'r', 'o', 't', 'o', '\022', '\024',
                                     'e', 'n',
                                     'v', 'o', 'y', '.', 'c', 'o', 'n', 'f', 'i', 'g', '.', 'c',
                                     'o', 'r', 'e', '.', 'v', '3', '\032', '\036', 'g', 'o', 'o',
                                     'g', 'l',
                                     'e', '/', 'p', 'r', 'o', 't', 'o', 'b', 'u', 'f', '/', 'w',
                                     ...
                                     't', 'e',
                                     '.', 'p', 'r', 'o', 't', 'o', '\"', '\250', '\001', '\n',
                                     '\017', 'U', 'd', 'p', 'S', 'o', 'c', 'k', 'e', 't', 'C', 'o',
                                     'n', 'f', 'i',
                                     'g', '\022', 'Z', '\n', '\024', 'm', 'a', 'x', '_', 'r', 'x',
                                     '_', 'd', 'a', 't', 'a', 'g', 'r', 'a', 'm', '_', 's', 'i',
                                     'z', 'e',
                                     '\030', '\001', ' ', '\001', '(', '\013', '2', '\034', '.',
                                     'g', 'o', 'o', 'g', 'l', 'e', '.', 'p', 'r', 'o', 't', 'o',
                                     'b', 'u', 'f', '.',
                                     'U', 'I', 'n', 't', '6', '4', 'V', 'a', 'l', 'u', 'e', 'B',
                                     '\013', '\372', 'B', '\010', '2', '\006', '\020', '\200',
                                     '\200', '\004', ' ', '\000', 'R',
                                     '\021', 'm', 'a', 'x', 'R', 'x', 'D', 'a', 't', 'a', 'g', 'r',
                                     'a', 'm', 'S', 'i', 'z', 'e', '\022', '9', '\n', '\n', 'p',
                                     'r', 'e',
                                     'f', 'e', 'r', '_', 'g', 'r', 'o', '\030', '\002', ' ', '\001',
                                     ...
                                     'v', 'o',
                                     'y', '.', 'c', 'o', 'n', 'f', 'i', 'g', '.', 'c', 'o', 'r',
                                     'e', '.', 'v', '3', 'B', '\024', 'U', 'd', 'p', 'S', 'o', 'c',
                                     'k',
                                     'e', 't', 'C', 'o', 'n', 'f', 'i', 'g', 'P', 'r', 'o', 't',
