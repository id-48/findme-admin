...
*
envoy_type_metadata_v3_MetadataKey_getmsgdef(upb_DefPool
*s) {
...
UPB_INLINE const upb_MessageDef
*
envoy_type_metadata_v3_MetadataKey_PathSegment_getmsgdef(upb_DefPool
*s) {
_upb_DefPool_LoadDefInit(s, &envoy_type_metadata_v3_metadata_proto_upbdefinit
);
return
...
UPB_INLINE const upb_MessageDef
*
envoy_type_metadata_v3_MetadataKind_getmsgdef(upb_DefPool
*s) {
_upb_DefPool_LoadDefInit(s, &envoy_type_metadata_v3_metadata_proto_upbdefinit
);
return
...
UPB_INLINE const upb_MessageDef
*
envoy_type_metadata_v3_MetadataKind_Request_getmsgdef(upb_DefPool
*s) {
_upb_DefPool_LoadDefInit(s, &envoy_type_metadata_v3_metadata_proto_upbdefinit
);
return
...
UPB_INLINE const upb_MessageDef
*
envoy_type_metadata_v3_MetadataKind_Route_getmsgdef(upb_DefPool
*s) {
_upb_DefPool_LoadDefInit(s, &envoy_type_metadata_v3_metadata_proto_upbdefinit
);
return
...
UPB_INLINE const upb_MessageDef
*
envoy_type_metadata_v3_MetadataKind_Cluster_getmsgdef(upb_DefPool
*s) {
_upb_DefPool_LoadDefInit(s, &envoy_type_metadata_v3_metadata_proto_upbdefinit
);
return
...
UPB_INLINE const upb_MessageDef
*
envoy_type_metadata_v3_MetadataKind_Host_getmsgdef(upb_DefPool
*s) {
_upb_DefPool_LoadDefInit(s, &envoy_type_metadata_v3_metadata_proto_upbdefinit
);
return
