...
static const char descriptor[416] = {'\n', '\036', 'e', 'n', 'v', 'o', 'y', '/', 'a', 'd', 'm', 'i',
                                     ...
                                     's', 'D', 'u',
                                     'm', 'p', 's', '\022', 'j', '\n', '\025', 'u', 'n', 'r', 'e',
                                     'a', 'd', 'y', '_', 't', 'a', 'r', 'g', 'e', 't', 's', '_',
                                     'd', 'u',
                                     'm', 'p', 's', '\030', '\001', ' ', '\003', '(', '\013', '2',
                                     '6', '.', 'e', 'n', 'v', 'o', 'y', '.', 'a', 'd', 'm', 'i',
                                     'n', '.', 'v',
                                     '3', '.', 'U', 'n', 'r', 'e', 'a', 'd', 'y', 'T', 'a', 'r',
                                     'g', 'e', 't', 's', 'D', 'u', 'm', 'p', 's', '.', 'U', 'n',
                                     'r',
                                     'e', 'a', 'd', 'y', 'T', 'a', 'r', 'g', 'e', 't', 's', 'D',
                                     'u', 'm', 'p', 'R', '\023', 'u', 'n', 'r', 'e', 'a', 'd', 'y',
                                     'T',
                                     'a', 'r', 'g', 'e', 't', 's', 'D', 'u', 'm', 'p', 's', '\032',
                                     'K', '\n', '\022', 'U', 'n', 'r', 'e', 'a', 'd', 'y', 'T', 'a',
                                     'r',
                                     'g', 'e', 't', 's', 'D', 'u', 'm', 'p', '\022', '\022', '\n',
                                     '\004', 'n', 'a', 'm', 'e', '\030', '\001', ' ', '\001', '(',
                                     '\t', 'R', '\004', 'n',
                                     'a', 'm', 'e', '\022', '!', '\n', '\014', 't', 'a', 'r', 'g',
                                     'e', 't', '_', 'n', 'a', 'm', 'e', 's', '\030', '\002', ' ',
                                     '\003', '(', '\t',
                                     'R', '\013', 't', 'a', 'r', 'g', 'e', 't', 'N', 'a', 'm', 'e',
                                     's', 'B', 'v', '\n', '\034', 'i', 'o', '.', 'e', 'n', 'v', 'o',
                                     'y',
                                     'p', 'r', 'o', 'x', 'y', '.', 'e', 'n', 'v', 'o', 'y', '.',
                                     'a', 'd', 'm', 'i', 'n', '.', 'v', '3', 'B', '\r', 'I', 'n',
                                     'i',
                                     't', 'D', 'u', 'm', 'p', 'P', 'r', 'o', 't', 'o', 'P', '\001',
                                     'Z', '=', 'g', 'i', 't', 'h', 'u', 'b', '.', 'c', 'o', 'm',
                                     '/',
