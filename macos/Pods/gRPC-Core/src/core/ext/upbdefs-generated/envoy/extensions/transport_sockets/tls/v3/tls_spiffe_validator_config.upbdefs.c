...
static const char descriptor[678] = {'\n', 'K', 'e', 'n', 'v', 'o', 'y', '/', 'e', 'x', 't', 'e',
                                     ...
                                     't', 'l', 's', '/', 'v', '3', '/', 't', 'l', 's', '_', 's',
                                     'p',
                                     'i', 'f', 'f', 'e', '_', 'v', 'a', 'l', 'i', 'd', 'a', 't',
                                     'o', 'r', '_', 'c', 'o', 'n', 'f', 'i', 'g', '.', 'p', 'r',
                                     'o',
                                     't', 'o', '\022', ')', 'e', 'n', 'v', 'o', 'y', '.', 'e', 'x',
                                     't', 'e', 'n', 's', 'i', 'o', 'n', 's', '.', 't', 'r', 'a',
                                     'n',
                                     's', 'p', 'o', 'r', 't', '_', 's', 'o', 'c', 'k', 'e', 't',
                                     's', '.', 't', 'l', 's', '.', 'v', '3', '\032', '\037', 'e',
                                     'n', 'v',
                                     'o', 'y', '/', 'c', 'o', 'n', 'f', 'i', 'g', '/', 'c', 'o',
                                     'r', 'e', '/', 'v', '3', '/', 'b', 'a', 's', 'e', '.', 'p',
                                     'r',
                                     ...
                                     '\002', '\n', '\031', 'S', 'P', 'I', 'F', 'F', 'E', 'C', 'e',
                                     'r', 't', 'V',
                                     'a', 'l', 'i', 'd', 'a', 't', 'o', 'r', 'C', 'o', 'n', 'f',
                                     'i', 'g', '\022', '\177', '\n', '\r', 't', 'r', 'u', 's', 't',
                                     '_', 'd',
                                     'o', 'm', 'a', 'i', 'n', 's', '\030', '\001', ' ', '\003', '(',
                                     '\013', '2', 'P', '.', 'e', 'n', 'v', 'o', 'y', '.', 'e', 'x',
                                     't', 'e',
                                     'n', 's', 'i', 'o', 'n', 's', '.', 't', 'r', 'a', 'n', 's',
                                     'p', 'o', 'r', 't', '_', 's', 'o', 'c', 'k', 'e', 't', 's',
                                     '.',
                                     't', 'l', 's', '.', 'v', '3', '.', 'S', 'P', 'I', 'F', 'F',
                                     'E', 'C', 'e', 'r', 't', 'V', 'a', 'l', 'i', 'd', 'a', 't',
                                     'o',
                                     'r', 'C', 'o', 'n', 'f', 'i', 'g', '.', 'T', 'r', 'u', 's',
                                     't', 'D', 'o', 'm', 'a', 'i', 'n', 'B', '\010', '\372', 'B',
                                     '\005', '\222',
                                     '\001', '\002', '\010', '\001', 'R', '\014', 't', 'r', 'u',
                                     's', 't', 'D', 'o', 'm', 'a', 'i', 'n', 's', '\032', 'o', '\n',
                                     '\013', 'T', 'r', 'u',
                                     's', 't', 'D', 'o', 'm', 'a', 'i', 'n', '\022', '\033', '\n',
                                     '\004', 'n', 'a', 'm', 'e', '\030', '\001', ' ', '\001', '(',
                                     '\t', 'B', '\007', '\372',
                                     'B', '\004', 'r', '\002', '\020', '\001', 'R', '\004', 'n',
                                     'a', 'm', 'e', '\022', 'C', '\n', '\014', 't', 'r', 'u', 's',
                                     't', '_', 'b', 'u', 'n',
                                     'd', 'l', 'e', '\030', '\002', ' ', '\001', '(', '\013', '2',
                                     ' ', '.', 'e', 'n', 'v', 'o', 'y', '.', 'c', 'o', 'n', 'f',
                                     'i', 'g', '.',
                                     'c', 'o', 'r', 'e', '.', 'v', '3', '.', 'D', 'a', 't', 'a',
                                     'S', 'o', 'u', 'r', 'c', 'e', 'R', '\013', 't', 'r', 'u', 's',
                                     't',
                                     ...
                                     's', '.', 'v', '3', 'B', '\035', 'T', 'l', 's', 'S', 'p', 'i',
                                     'f',
                                     'f', 'e', 'V', 'a', 'l', 'i', 'd', 'a', 't', 'o', 'r', 'C',
