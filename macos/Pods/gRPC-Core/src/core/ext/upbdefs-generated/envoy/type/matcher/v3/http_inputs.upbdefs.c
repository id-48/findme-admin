...
static const char descriptor[579] = {'\n', '\'', 'e', 'n', 'v', 'o', 'y', '/', 't', 'y', 'p', 'e',
                                     ...
                                     't', 'e', '.', 'p', 'r', 'o', 't', 'o', '\"', 'K', '\n',
                                     '\033', 'H',
                                     't', 't', 'p', 'R', 'e', 'q', 'u', 'e', 's', 't', 'H', 'e',
                                     'a', 'd', 'e', 'r', 'M', 'a', 't', 'c', 'h', 'I', 'n', 'p',
                                     'u',
                                     't', '\022', ',', '\n', '\013', 'h', 'e', 'a', 'd', 'e', 'r',
                                     '_', 'n', 'a', 'm', 'e', '\030', '\001', ' ', '\001', '(',
                                     '\t', 'B', '\013', '\372',
                                     'B', '\010', 'r', '\006', '\300', '\001', '\001', '\310',
                                     '\001', '\000', 'R', '\n', 'h', 'e', 'a', 'd', 'e', 'r', 'N',
                                     'a', 'm', 'e', '\"', 'L', '\n',
                                     '\034', 'H', 't', 't', 'p', 'R', 'e', 'q', 'u', 'e', 's', 't',
                                     'T', 'r', 'a', 'i', 'l', 'e', 'r', 'M', 'a', 't', 'c', 'h',
                                     'I',
                                     'n', 'p', 'u', 't', '\022', ',', '\n', '\013', 'h', 'e', 'a',
                                     'd', 'e', 'r', '_', 'n', 'a', 'm', 'e', '\030', '\001', ' ',
                                     '\001', '(', '\t',
                                     'B', '\013', '\372', 'B', '\010', 'r', '\006', '\300', '\001',
                                     '\001', '\310', '\001', '\000', 'R', '\n', 'h', 'e', 'a', 'd',
                                     'e', 'r', 'N', 'a', 'm', 'e',
                                     '\"', 'L', '\n', '\034', 'H', 't', 't', 'p', 'R', 'e', 's',
                                     'p', 'o', 'n', 's', 'e', 'H', 'e', 'a', 'd', 'e', 'r', 'M',
                                     'a', 't',
                                     'c', 'h', 'I', 'n', 'p', 'u', 't', '\022', ',', '\n', '\013',
                                     'h', 'e', 'a', 'd', 'e', 'r', '_', 'n', 'a', 'm', 'e', '\030',
                                     '\001', ' ',
                                     '\001', '(', '\t', 'B', '\013', '\372', 'B', '\010', 'r',
                                     '\006', '\300', '\001', '\001', '\310', '\001', '\000', 'R',
                                     '\n', 'h', 'e', 'a', 'd', 'e', 'r', 'N',
                                     'a', 'm', 'e', '\"', 'M', '\n', '\035', 'H', 't', 't', 'p',
                                     'R', 'e', 's', 'p', 'o', 'n', 's', 'e', 'T', 'r', 'a', 'i',
                                     'l', 'e',
