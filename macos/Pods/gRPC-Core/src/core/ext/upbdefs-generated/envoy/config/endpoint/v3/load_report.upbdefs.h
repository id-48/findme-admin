...
*
envoy_config_endpoint_v3_UpstreamLocalityStats_getmsgdef(upb_DefPool
*s) {
...
UPB_INLINE const upb_MessageDef
*
envoy_config_endpoint_v3_UpstreamEndpointStats_getmsgdef(upb_DefPool
*s) {
_upb_DefPool_LoadDefInit(s, &envoy_config_endpoint_v3_load_report_proto_upbdefinit
);
return
...
UPB_INLINE const upb_MessageDef
*
envoy_config_endpoint_v3_EndpointLoadMetricStats_getmsgdef(upb_DefPool
*s) {
_upb_DefPool_LoadDefInit(s, &envoy_config_endpoint_v3_load_report_proto_upbdefinit
);
return
...
UPB_INLINE const upb_MessageDef
*
envoy_config_endpoint_v3_ClusterStats_getmsgdef(upb_DefPool
*s) {
_upb_DefPool_LoadDefInit(s, &envoy_config_endpoint_v3_load_report_proto_upbdefinit
);
return
...
UPB_INLINE const upb_MessageDef
*
envoy_config_endpoint_v3_ClusterStats_DroppedRequests_getmsgdef(upb_DefPool
*s) {
_upb_DefPool_LoadDefInit(s, &envoy_config_endpoint_v3_load_report_proto_upbdefinit
);
return
