...
static const char descriptor[1444] = {'\n', '4', 'e', 'n', 'v', 'o', 'y', '/', 'e', 'x', 't', 'e',
                                      ...
                                      '3',
                                      '.', 'F', 'a', 'u', 'l', 't', 'D', 'e', 'l', 'a', 'y', '.',
                                      'H', 'e', 'a', 'd', 'e', 'r', 'D', 'e', 'l', 'a', 'y', 'H',
                                      '\000',
                                      'R', '\013', 'h', 'e', 'a', 'd', 'e', 'r', 'D', 'e', 'l', 'a',
                                      'y', '\022', '@', '\n', '\n', 'p', 'e', 'r', 'c', 'e', 'n',
                                      't', 'a',
                                      'g', 'e', '\030', '\004', ' ', '\001', '(', '\013', '2', ' ',
                                      '.', 'e', 'n', 'v', 'o', 'y', '.', 't', 'y', 'p', 'e', '.',
                                      'v', '3', '.',
                                      'F', 'r', 'a', 'c', 't', 'i', 'o', 'n', 'a', 'l', 'P', 'e',
                                      'r', 'c', 'e', 'n', 't', 'R', '\n', 'p', 'e', 'r', 'c', 'e',
                                      'n',
                                      't', 'a', 'g', 'e', '\032', 'I', '\n', '\013', 'H', 'e', 'a',
                                      'd', 'e', 'r', 'D', 'e', 'l', 'a', 'y', ':', ':', '\232',
                                      ...
                                      'a',
                                      'u', 'l', 't', '.', 'v', '2', '.', 'F', 'a', 'u', 'l', 't',
                                      'D', 'e', 'l', 'a', 'y', '.', 'H', 'e', 'a', 'd', 'e', 'r',
                                      'D',
                                      'e', 'l', 'a', 'y', '\"', '\033', '\n', '\016', 'F', 'a', 'u',
                                      'l', 't', 'D', 'e', 'l', 'a', 'y', 'T', 'y', 'p', 'e', '\022',
                                      '\t', '\n',
                                      '\005', 'F', 'I', 'X', 'E', 'D', '\020', '\000', ':', '.',
                                      '\232', '\305', '\210', '\036', ')', '\n', '\'', 'e', 'n',
                                      'v', 'o', 'y', '.', 'c', 'o',
                                      'n', 'f', 'i', 'g', '.', 'f', 'i', 'l', 't', 'e', 'r', '.',
                                      'f', 'a', 'u', 'l', 't', '.', 'v', '2', '.', 'F', 'a', 'u',
                                      'l',
                                      't', 'D', 'e', 'l', 'a', 'y', 'B', '\033', '\n', '\024', 'f',
                                      'a', 'u', 'l', 't', '_', 'd', 'e', 'l', 'a', 'y', '_', 's',
                                      'e', 'c',
                                      'i', 'f', 'i', 'e', 'r', '\022', '\003', '\370', 'B', '\001',
                                      'J', '\004', '\010', '\002', '\020', '\003', 'J', '\004',
                                      '\010', '\001', '\020', '\002', 'R', '\004', 't',
                                      'y', 'p', 'e', '\"', '\260', '\004', '\n', '\016', 'F', 'a',
                                      'u', 'l', 't', 'R', 'a', 't', 'e', 'L', 'i', 'm', 'i', 't',
                                      '\022', 'f', '\n',
                                      '\013', 'f', 'i', 'x', 'e', 'd', '_', 'l', 'i', 'm', 'i', 't',
                                      '\030', '\001', ' ', '\001', '(', '\013', '2', 'C', '.', 'e',
                                      'n', 'v', 'o',
                                      ...
                                      't', '\022', '&', '\n', '\n', 'l', 'i', 'm', 'i', 't', '_',
                                      'k', 'b',
                                      'p', 's', '\030', '\001', ' ', '\001', '(', '\004', 'B',
                                      '\007', '\372', 'B', '\004', '2', '\002', '(', '\001', 'R',
                                      '\t', 'l', 'i', 'm', 'i', 't', 'K',
                                      'b', 'p', 's', ':', '=', '\232', '\305', '\210', '\036', '8',
                                      '\n', '6', 'e', 'n', 'v', 'o', 'y', '.', 'c', 'o', 'n', 'f',
                                      'i', 'g', '.',
                                      'f', 'i', 'l', 't', 'e', 'r', '.', 'f', 'a', 'u', 'l', 't',
                                      '.', 'v', '2', '.', 'F', 'a', 'u', 'l', 't', 'R', 'a', 't',
                                      'e',
                                      'L', 'i', 'm', 'i', 't', '.', 'F', 'i', 'x', 'e', 'd', 'L',
                                      'i', 'm', 'i', 't', '\032', 'M', '\n', '\013', 'H', 'e', 'a',
                                      'd', 'e',
                                      'r', 'L', 'i', 'm', 'i', 't', ':', '>', '\232', '\305',
                                      '\210', '\036', '9', '\n', '7', 'e', 'n', 'v', 'o', 'y', '.',
                                      ...
                                      'u', 'l', 't', '.', 'v', '2', '.', 'F', 'a', 'u', 'l', 't',
                                      'R',
                                      'a', 't', 'e', 'L', 'i', 'm', 'i', 't', '.', 'H', 'e', 'a',
                                      'd', 'e', 'r', 'L', 'i', 'm', 'i', 't', ':', '2', '\232',
                                      '\305', '\210',
                                      '\036', '-', '\n', '+', 'e', 'n', 'v', 'o', 'y', '.', 'c',
                                      'o', 'n', 'f', 'i', 'g', '.', 'f', 'i', 'l', 't', 'e', 'r',
                                      '.', 'f',
                                      'a', 'u', 'l', 't', '.', 'v', '2', '.', 'F', 'a', 'u', 'l',
                                      't', 'R', 'a', 't', 'e', 'L', 'i', 'm', 'i', 't', 'B', '\021',
                                      '\n',
                                      '\n', 'l', 'i', 'm', 'i', 't', '_', 't', 'y', 'p', 'e',
                                      '\022', '\003', '\370', 'B', '\001', 'B', '\247', '\001',
                                      '\n', '6', 'i', 'o', '.', 'e',
