...
static const char descriptor[439] = {'\n', ' ', 'e', 'n', 'v', 'o', 'y', '/', 'a', 'd', 'm', 'i',
                                     ...
                                     't', 'e',
                                     'x', 'S', 't', 'a', 't', 's', '\022', '\'', '\n', '\017', 'n',
                                     'u', 'm', '_', 'c', 'o', 'n', 't', 'e', 'n', 't', 'i', 'o',
                                     'n', 's',
                                     '\030', '\001', ' ', '\001', '(', '\004', 'R', '\016', 'n',
                                     'u', 'm', 'C', 'o', 'n', 't', 'e', 'n', 't', 'i', 'o', 'n',
                                     's', '\022', '.', '\n',
                                     '\023', 'c', 'u', 'r', 'r', 'e', 'n', 't', '_', 'w', 'a', 'i',
                                     't', '_', 'c', 'y', 'c', 'l', 'e', 's', '\030', '\002', ' ',
                                     '\001', '(',
                                     '\004', 'R', '\021', 'c', 'u', 'r', 'r', 'e', 'n', 't', 'W',
                                     'a', 'i', 't', 'C', 'y', 'c', 'l', 'e', 's', '\022', '0', '\n',
                                     '\024', 'l',
                                     'i', 'f', 'e', 't', 'i', 'm', 'e', '_', 'w', 'a', 'i', 't',
                                     '_', 'c', 'y', 'c', 'l', 'e', 's', '\030', '\003', ' ', '\001',
                                     '(', '\004',
                                     'R', '\022', 'l', 'i', 'f', 'e', 't', 'i', 'm', 'e', 'W', 'a',
                                     'i', 't', 'C', 'y', 'c', 'l', 'e', 's', ':', '%', '\232',
                                     '\305', '\210',
                                     '\036', ' ', '\n', '\036', 'e', 'n', 'v', 'o', 'y', '.', 'a',
                                     ...
                                     'x',
                                     'y', '.', 'e', 'n', 'v', 'o', 'y', '.', 'a', 'd', 'm', 'i',
                                     'n', '.', 'v', '3', 'B', '\017', 'M', 'u', 't', 'e', 'x', 'S',
                                     't',
                                     'a', 't', 's', 'P', 'r', 'o', 't', 'o', 'P', '\001', 'Z', '=',
                                     'g', 'i', 't', 'h', 'u', 'b', '.', 'c', 'o', 'm', '/', 'e',
                                     'n',
                                     'v', 'o', 'y', 'p', 'r', 'o', 'x', 'y', '/', 'g', 'o', '-',
