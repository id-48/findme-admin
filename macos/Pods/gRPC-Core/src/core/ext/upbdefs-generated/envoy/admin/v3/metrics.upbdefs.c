...
static const char descriptor[426] = {'\n', '\034', 'e', 'n', 'v', 'o', 'y', '/', 'a', 'd', 'm', 'i',
                                     'n', '/', 'v', '3', '/', 'm', 'e', 't', 'r', 'i', 'c', 's',
                                     '.',
                                     'p', 'r', 'o', 't', 'o', '\022', '\016', 'e', 'n', 'v', 'o',
                                     'y', '.', 'a', 'd', 'm', 'i', 'n', '.', 'v', '3', '\032',
                                     '\035', 'u', 'd',
                                     ...
                                     '\013', '\n', '\007', 'C', 'O', 'U', 'N', 'T', 'E', 'R',
                                     '\020', '\000', '\022', '\t', '\n',
                                     '\005', 'G', 'A', 'U', 'G', 'E', '\020', '\001', ':', '\'',
                                     '\232', '\305', '\210', '\036', '\"', '\n', ' ', 'e', 'n', 'v',
                                     'o', 'y', '.', 'a', 'd',
                                     'm', 'i', 'n', '.', 'v', '2', 'a', 'l', 'p', 'h', 'a', '.',
                                     'S', 'i', 'm', 'p', 'l', 'e', 'M', 'e', 't', 'r', 'i', 'c',
                                     'B',
                                     'u', '\n', '\034', 'i', 'o', '.', 'e', 'n', 'v', 'o', 'y', 'p',
                                     'r', 'o', 'x', 'y', '.', 'e', 'n', 'v', 'o', 'y', '.', 'a',
                                     'd',
                                     'm', 'i', 'n', '.', 'v', '3', 'B', '\014', 'M', 'e', 't', 'r',
                                     'i', 'c', 's', 'P', 'r', 'o', 't', 'o', 'P', '\001', 'Z', '=',
                                     'g',
                                     'i', 't', 'h', 'u', 'b', '.', 'c', 'o', 'm', '/', 'e', 'n',
                                     'v', 'o', 'y', 'p', 'r', 'o', 'x', 'y', '/', 'g', 'o', '-',
                                     'c',
