...
static const char descriptor[477] = {'\n', '\"', 'e', 'n', 'v', 'o', 'y', '/', 't', 'y', 'p', 'e',
                                     '/', 'm', 'a', 't', 'c', 'h', 'e', 'r', '/', 'v', '3', '/',
                                     'n',
                                     'u', 'm', 'b', 'e', 'r', '.', 'p', 'r', 'o', 't', 'o', '\022',
                                     '\025', 'e', 'n', 'v', 'o', 'y', '.', 't', 'y', 'p', 'e', '.',
                                     'm',
                                     'a', 't', 'c', 'h', 'e', 'r', '.', 'v', '3', '\032', '\031',
                                     'e', 'n', 'v', 'o', 'y', '/', 't', 'y', 'p', 'e', '/', 'v',
                                     '3', '/',
                                     'r', 'a', 'n', 'g', 'e', '.', 'p', 'r', 'o', 't', 'o', '\032',
                                     ...
                                     'r', 'o',
                                     't', 'o', '\"', '\232', '\001', '\n', '\r', 'D', 'o', 'u', 'b',
                                     'l', 'e', 'M', 'a', 't', 'c', 'h', 'e', 'r', '\022', '2', '\n',
                                     '\005', 'r',
                                     'a', 'n', 'g', 'e', '\030', '\001', ' ', '\001', '(', '\013',
                                     '2', '\032', '.', 'e', 'n', 'v', 'o', 'y', '.', 't', 'y', 'p',
                                     'e', '.', 'v',
                                     '3', '.', 'D', 'o', 'u', 'b', 'l', 'e', 'R', 'a', 'n', 'g',
                                     'e', 'H', '\000', 'R', '\005', 'r', 'a', 'n', 'g', 'e', '\022',
                                     '\026', '\n',
                                     '\005', 'e', 'x', 'a', 'c', 't', '\030', '\002', ' ', '\001',
                                     '(', '\001', 'H', '\000', 'R', '\005', 'e', 'x', 'a', 'c', 't',
                                     ':', '\'', '\232', '\305',
                                     '\210', '\036', '\"', '\n', ' ', 'e', 'n', 'v', 'o', 'y', '.',
                                     't', 'y', 'p', 'e', '.', 'm', 'a', 't', 'c', 'h', 'e', 'r',
                                     '.', 'D',
                                     'o', 'u', 'b', 'l', 'e', 'M', 'a', 't', 'c', 'h', 'e', 'r',
                                     'B', '\024', '\n', '\r', 'm', 'a', 't', 'c', 'h', '_', 'p',
                                     'a', 't',
