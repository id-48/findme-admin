...
static const char descriptor[659] = {'\n', '(', 'e', 'n', 'v', 'o', 'y', '/', 'c', 'o', 'n', 'f',
                                     ...
                                     '\030', '\001', ' ', '\001', '(', '\t', 'R', '\013', 'd', 'e',
                                     's', 'c', 'r',
                                     'i', 'p', 't', 'i', 'o', 'n', '\022', '\024', '\n', '\005',
                                     'l', 'e', 'v', 'e', 'l', '\030', '\002', ' ', '\001', '(',
                                     '\003', 'R', '\005', 'l', 'e',
                                     'v', 'e', 'l', '\022', '\022', '\n', '\004', 'n', 'a', 'm',
                                     'e', '\030', '\003', ' ', '\001', '(', '\003', 'R', '\004',
                                     'n', 'a', 'm', 'e', '\022', '\035',
                                     '\n', '\t', 'i', 'n', 't', '_', 'v', 'a', 'l', 'u', 'e',
                                     ...
                                     '\014', 'H', '\000',
                                     'R', '\010', 'b', 'u', 'f', 'V', 'a', 'l', 'u', 'e', '\022',
                                     'N', '\n', '\005', 's', 't', 'a', 't', 'e', '\030', '\006',
                                     ' ', '\001', '(', '\016',
                                     '2', '.', '.', 'e', 'n', 'v', 'o', 'y', '.', 'c', 'o', 'n',
                                     'f', 'i', 'g', '.', 'c', 'o', 'r', 'e', '.', 'v', '3', '.',
                                     'S',
                                     'o', 'c', 'k', 'e', 't', 'O', 'p', 't', 'i', 'o', 'n', '.',
                                     'S', 'o', 'c', 'k', 'e', 't', 'S', 't', 'a', 't', 'e', 'B',
                                     '\010',
                                     '\372', 'B', '\005', '\202', '\001', '\002', '\020', '\001',
                                     'R', '\005', 's', 't', 'a', 't', 'e', '\"', 'F', '\n', '\013',
                                     'S', 'o', 'c', 'k', 'e', 't',
                                     'S', 't', 'a', 't', 'e', '\022', '\021', '\n', '\r', 'S', 'T',
                                     'A', 'T', 'E', '_', 'P', 'R', 'E', 'B', 'I', 'N', 'D', '\020',
                                     '\000', '\022',
                                     '\017', '\n', '\013', 'S', 'T', 'A', 'T', 'E', '_', 'B', 'O',
                                     'U', 'N', 'D', '\020', '\001', '\022', '\023', '\n', '\017',
                                     'S', 'T', 'A', 'T', 'E',
                                     '_', 'L', 'I', 'S', 'T', 'E', 'N', 'I', 'N', 'G', '\020',
                                     '\002', ':', '%', '\232', '\305', '\210', '\036', ' ', '\n',
                                     '\036', 'e', 'n', 'v', 'o',
                                     'y', '.', 'a', 'p', 'i', '.', 'v', '2', '.', 'c', 'o', 'r',
                                     'e', '.', 'S', 'o', 'c', 'k', 'e', 't', 'O', 'p', 't', 'i',
                                     'o',
                                     'n', 'B', '\014', '\n', '\005', 'v', 'a', 'l', 'u', 'e',
                                     '\022', '\003', '\370', 'B', '\001', 'B', '\205', '\001', '\n',
                                     '\"', 'i', 'o', '.', 'e', 'n',
                                     'v', 'o', 'y', 'p', 'r', 'o', 'x', 'y', '.', 'e', 'n', 'v',
                                     'o', 'y', '.', 'c', 'o', 'n', 'f', 'i', 'g', '.', 'c', 'o',
                                     'r',
                                     'e', '.', 'v', '3', 'B', '\021', 'S', 'o', 'c', 'k', 'e', 't',
                                     'O', 'p', 't', 'i', 'o', 'n', 'P', 'r', 'o', 't', 'o', 'P',
                                     '\001',
