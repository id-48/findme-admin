...
static const char descriptor[1015] = {'\n', '!', 'e', 'n', 'v', 'o', 'y', '/', 't', 'y', 'p', 'e',
                                      ...
                                      'm', 'a', 't',
                                      'c', 'h', 'e', 'r', '.', 'v', '3', '.', 'V', 'a', 'l', 'u',
                                      'e', 'M', 'a', 't', 'c', 'h', 'e', 'r', '.', 'N', 'u', 'l',
                                      'l',
                                      'M', 'a', 't', 'c', 'h', 'H', '\000', 'R', '\t', 'n', 'u',
                                      'l', 'l', 'M', 'a', 't', 'c', 'h', '\022', 'I', '\n', '\014',
                                      'd', 'o', 'u',
                                      'b', 'l', 'e', '_', 'm', 'a', 't', 'c', 'h', '\030', '\002',
                                      ' ', '\001', '(', '\013', '2', '$', '.', 'e', 'n', 'v', 'o',
                                      'y', '.', 't',
                                      'y', 'p', 'e', '.', 'm', 'a', 't', 'c', 'h', 'e', 'r', '.',
                                      'v', '3', '.', 'D', 'o', 'u', 'b', 'l', 'e', 'M', 'a', 't',
                                      'c',
                                      'h', 'e', 'r', 'H', '\000', 'R', '\013', 'd', 'o', 'u', 'b',
                                      'l', 'e', 'M', 'a', 't', 'c', 'h', '\022', 'I', '\n', '\014',
                                      's', 't', 'r',
                                      'i', 'n', 'g', '_', 'm', 'a', 't', 'c', 'h', '\030', '\003',
                                      ' ', '\001', '(', '\013', '2', '$', '.', 'e', 'n', 'v', 'o',
                                      'y', '.', 't',
                                      'y', 'p', 'e', '.', 'm', 'a', 't', 'c', 'h', 'e', 'r', '.',
                                      'v', '3', '.', 'S', 't', 'r', 'i', 'n', 'g', 'M', 'a', 't',
                                      'c',
                                      'h', 'e', 'r', 'H', '\000', 'R', '\013', 's', 't', 'r', 'i',
                                      'n', 'g', 'M', 'a', 't', 'c', 'h', '\022', '\037', '\n', '\n',
                                      'b', 'o', 'o',
                                      'l', '_', 'm', 'a', 't', 'c', 'h', '\030', '\004', ' ',
                                      '\001', '(', '\010', 'H', '\000', 'R', '\t', 'b', 'o', 'o',
                                      'l', 'M', 'a', 't', 'c',
                                      'h', '\022', '%', '\n', '\r', 'p', 'r', 'e', 's', 'e', 'n',
                                      't', '_', 'm', 'a', 't', 'c', 'h', '\030', '\005', ' ',
                                      '\001', '(', '\010', 'H',
                                      '\000', 'R', '\014', 'p', 'r', 'e', 's', 'e', 'n', 't', 'M',
                                      'a', 't', 'c', 'h', '\022', 'C', '\n', '\n', 'l', 'i', 's',
                                      't', '_', 'm',
                                      'a', 't', 'c', 'h', '\030', '\006', ' ', '\001', '(', '\013',
                                      '2', '\"', '.', 'e', 'n', 'v', 'o', 'y', '.', 't', 'y', 'p',
                                      'e', '.', 'm',
                                      'a', 't', 'c', 'h', 'e', 'r', '.', 'v', '3', '.', 'L', 'i',
                                      's', 't', 'M', 'a', 't', 'c', 'h', 'e', 'r', 'H', '\000', 'R',
                                      '\t',
                                      ...
                                      '.', 'v', '3', '.', 'V', 'a', 'l', 'u', 'e', 'M', 'a', 't',
                                      'c',
                                      'h', 'e', 'r', 'H', '\000', 'R', '\005', 'o', 'n', 'e', 'O',
                                      'f', ':', '%', '\232', '\305', '\210', '\036', ' ', '\n',
                                      '\036', 'e', 'n', 'v', 'o',
                                      'y', '.', 't', 'y', 'p', 'e', '.', 'm', 'a', 't', 'c', 'h',
                                      'e', 'r', '.', 'L', 'i', 's', 't', 'M', 'a', 't', 'c', 'h',
                                      'e',
                                      'r', 'B', '\024', '\n', '\r', 'm', 'a', 't', 'c', 'h', '_',
                                      'p', 'a', 't', 't', 'e', 'r', 'n', '\022', '\003', '\370',
                                      'B', '\001', 'B', '\203',
                                      '\001', '\n', '#', 'i', 'o', '.', 'e', 'n', 'v', 'o', 'y',
                                      'p', 'r', 'o', 'x', 'y', '.', 'e', 'n', 'v', 'o', 'y', '.',
                                      't', 'y',
