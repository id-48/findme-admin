...
static const char descriptor[573] = {'\n', '+', 'e', 'n', 'v', 'o', 'y', '/', 'c', 'o', 'n', 'f',
                                     'i', 'g', '/', 'c', 'o', 'r', 'e', '/', 'v', '3', '/', 'g',
                                     'r',
                                     'p', 'c', '_', 'm', 'e', 't', 'h', 'o', 'd', '_', 'l', 'i',
                                     's', 't', '.', 'p', 'r', 'o', 't', 'o', '\022', '\024', 'e',
                                     'n', 'v',
                                     'o', 'y', '.', 'c', 'o', 'n', 'f', 'i', 'g', '.', 'c', 'o',
                                     'r', 'e', '.', 'v', '3', '\032', '\035', 'u', 'd', 'p', 'a',
                                     '/', 'a',
                                     ...
                                     'o', 'r', 'e', '.', 'v', '3', '.', 'G', 'r', 'p', 'c', 'M',
                                     'e',
                                     't', 'h', 'o', 'd', 'L', 'i', 's', 't', '.', 'S', 'e', 'r',
                                     'v', 'i', 'c', 'e', 'R', '\010', 's', 'e', 'r', 'v', 'i', 'c',
                                     'e',
                                     's', '\032', '\204', '\001', '\n', '\007', 'S', 'e', 'r', 'v',
                                     'i', 'c', 'e', '\022', '\033', '\n', '\004', 'n', 'a', 'm',
                                     'e', '\030', '\001', ' ', '\001',
                                     ...
                                     '\n', '\014', 'm', 'e', 't', 'h',
                                     'o', 'd', '_', 'n', 'a', 'm', 'e', 's', '\030', '\002', ' ',
                                     '\003', '(', '\t', 'B', '\010', '\372', 'B', '\005', '\222',
                                     '\001', '\002', '\010', '\001', 'R',
                                     '\013', 'm', 'e', 't', 'h', 'o', 'd', 'N', 'a', 'm', 'e', 's',
                                     ':', '/', '\232', '\305', '\210', '\036', '*', '\n', '(', 'e',
                                     'n', 'v', 'o',
                                     'y', '.', 'a', 'p', 'i', '.', 'v', '2', '.', 'c', 'o', 'r',
                                     'e', '.', 'G', 'r', 'p', 'c', 'M', 'e', 't', 'h', 'o', 'd',
                                     'L',
                                     'i', 's', 't', '.', 'S', 'e', 'r', 'v', 'i', 'c', 'e', ':',
                                     '\'', '\232', '\305', '\210', '\036', '\"', '\n', ' ', 'e',
                                     'n', 'v', 'o', 'y',
                                     '.', 'a', 'p', 'i', '.', 'v', '2', '.', 'c', 'o', 'r', 'e',
                                     '.', 'G', 'r', 'p', 'c', 'M', 'e', 't', 'h', 'o', 'd', 'L',
                                     'i',
                                     's', 't', 'B', '\207', '\001', '\n', '\"', 'i', 'o', '.', 'e',
                                     'n', 'v', 'o', 'y', 'p', 'r', 'o', 'x', 'y', '.', 'e', 'n',
                                     'v', 'o',
                                     'y', '.', 'c', 'o', 'n', 'f', 'i', 'g', '.', 'c', 'o', 'r',
                                     'e', '.', 'v', '3', 'B', '\023', 'G', 'r', 'p', 'c', 'M', 'e',
                                     't',
                                     'h', 'o', 'd', 'L', 'i', 's', 't', 'P', 'r', 'o', 't', 'o',
