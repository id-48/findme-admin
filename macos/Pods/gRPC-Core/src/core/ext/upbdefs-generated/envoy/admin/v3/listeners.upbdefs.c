...
static const char descriptor[650] = {'\n', '\036', 'e', 'n', 'v', 'o', 'y', '/', 'a', 'd', 'm', 'i',
                                     'n', '/', 'v', '3', '/', 'l', 'i', 's', 't', 'e', 'n', 'e',
                                     'r',
                                     's', '.', 'p', 'r', 'o', 't', 'o', '\022', '\016', 'e', 'n',
                                     'v', 'o', 'y', '.', 'a', 'd', 'm', 'i', 'n', '.', 'v', '3',
                                     '\032', '\"',
                                     'e', 'n', 'v', 'o', 'y', '/', 'c', 'o', 'n', 'f', 'i', 'g',
                                     '/', 'c', 'o', 'r', 'e', '/', 'v', '3', '/', 'a', 'd', 'd',
                                     'r',
                                     'e', 's', 's', '.', 'p', 'r', 'o', 't', 'o', '\032', '\035',
                                     ...
                                     's', '\022', 'K', '\n', '\021', 'l', 'i', 's', 't', 'e', 'n',
                                     'e', 'r',
                                     '_', 's', 't', 'a', 't', 'u', 's', 'e', 's', '\030', '\001',
                                     ' ', '\003', '(', '\013', '2', '\036', '.', 'e', 'n', 'v', 'o',
                                     'y', '.', 'a',
                                     'd', 'm', 'i', 'n', '.', 'v', '3', '.', 'L', 'i', 's', 't',
                                     'e', 'n', 'e', 'r', 'S', 't', 'a', 't', 'u', 's', 'R', '\020',
                                     'l',
                                     'i', 's', 't', 'e', 'n', 'e', 'r', 'S', 't', 'a', 't', 'u',
                                     's', 'e', 's', ':', '$', '\232', '\305', '\210', '\036',
                                     '\037', '\n', '\035', 'e',
                                     'n', 'v', 'o', 'y', '.', 'a', 'd', 'm', 'i', 'n', '.', 'v',
                                     '2', 'a', 'l', 'p', 'h', 'a', '.', 'L', 'i', 's', 't', 'e',
                                     'n',
                                     'e', 'r', 's', '\"', '\360', '\001', '\n', '\016', 'L', 'i',
                                     's', 't', 'e', 'n', 'e', 'r', 'S', 't', 'a', 't', 'u', 's',
                                     '\022', '\022', '\n',
                                     '\004', 'n', 'a', 'm', 'e', '\030', '\001', ' ', '\001', '(',
                                     '\t', 'R', '\004', 'n', 'a', 'm', 'e', '\022', 'B', '\n', '\r',
                                     'l', 'o', 'c', 'a',
                                     'l', '_', 'a', 'd', 'd', 'r', 'e', 's', 's', '\030', '\002',
                                     ' ', '\001', '(', '\013', '2', '\035', '.', 'e', 'n', 'v', 'o',
                                     'y', '.', 'c',
                                     'o', 'n', 'f', 'i', 'g', '.', 'c', 'o', 'r', 'e', '.', 'v',
                                     '3', '.', 'A', 'd', 'd', 'r', 'e', 's', 's', 'R', '\014', 'l',
                                     'o',
                                     'c', 'a', 'l', 'A', 'd', 'd', 'r', 'e', 's', 's', '\022', '[',
                                     '\n', '\032', 'a', 'd', 'd', 'i', 't', 'i', 'o', 'n', 'a', 'l',
                                     '_',
                                     'l', 'o', 'c', 'a', 'l', '_', 'a', 'd', 'd', 'r', 'e', 's',
                                     's', 'e', 's', '\030', '\003', ' ', '\003', '(', '\013', '2',
                                     '\035', '.', 'e',
                                     'n', 'v', 'o', 'y', '.', 'c', 'o', 'n', 'f', 'i', 'g', '.',
                                     'c', 'o', 'r', 'e', '.', 'v', '3', '.', 'A', 'd', 'd', 'r',
                                     'e',
                                     's', 's', 'R', '\030', 'a', 'd', 'd', 'i', 't', 'i', 'o', 'n',
                                     'a', 'l', 'L', 'o', 'c', 'a', 'l', 'A', 'd', 'd', 'r', 'e',
                                     's',
                                     's', 'e', 's', ':', ')', '\232', '\305', '\210', '\036', '$',
                                     '\n', '\"', 'e', 'n', 'v', 'o', 'y', '.', 'a', 'd', 'm', 'i',
                                     'n', '.', 'v',
                                     '2', 'a', 'l', 'p', 'h', 'a', '.', 'L', 'i', 's', 't', 'e',
                                     'n', 'e', 'r', 'S', 't', 'a', 't', 'u', 's', 'B', 'w', '\n',
                                     '\034',
                                     'i', 'o', '.', 'e', 'n', 'v', 'o', 'y', 'p', 'r', 'o', 'x',
                                     'y', '.', 'e', 'n', 'v', 'o', 'y', '.', 'a', 'd', 'm', 'i',
                                     'n',
                                     '.', 'v', '3', 'B', '\016', 'L', 'i', 's', 't', 'e', 'n', 'e',
                                     'r', 's', 'P', 'r', 'o', 't', 'o', 'P', '\001', 'Z', '=', 'g',
                                     'i',
                                     't', 'h', 'u', 'b', '.', 'c', 'o', 'm', '/', 'e', 'n', 'v',
                                     'o', 'y', 'p', 'r', 'o', 'x', 'y', '/', 'g', 'o', '-', 'c',
                                     'o',
