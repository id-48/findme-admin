...
*
envoy_config_cluster_v3_CircuitBreakers_getmsgdef(upb_DefPool
*s) {
...
UPB_INLINE const upb_MessageDef
*
envoy_config_cluster_v3_CircuitBreakers_Thresholds_getmsgdef(upb_DefPool
*s) {
_upb_DefPool_LoadDefInit(s, &envoy_config_cluster_v3_circuit_breaker_proto_upbdefinit
);
return
...
UPB_INLINE const upb_MessageDef
*
envoy_config_cluster_v3_CircuitBreakers_Thresholds_RetryBudget_getmsgdef(upb_DefPool
*s) {
_upb_DefPool_LoadDefInit(s, &envoy_config_cluster_v3_circuit_breaker_proto_upbdefinit
);
return
