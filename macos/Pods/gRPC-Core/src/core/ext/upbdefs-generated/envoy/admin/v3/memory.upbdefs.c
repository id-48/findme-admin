...
static const char descriptor[520] = {'\n', '\033', 'e', 'n', 'v', 'o', 'y', '/', 'a', 'd', 'm', 'i',
                                     ...
                                     '\230', '\002', '\n', '\006', 'M', 'e', 'm', 'o', 'r', 'y',
                                     '\022', '\034', '\n',
                                     '\t', 'a', 'l', 'l', 'o', 'c', 'a', 't', 'e', 'd', '\030',
                                     '\001', ' ', '\001', '(', '\004', 'R', '\t', 'a', 'l', 'l',
                                     'o', 'c', 'a', 't',
                                     'e', 'd', '\022', '\033', '\n', '\t', 'h', 'e', 'a', 'p', '_',
                                     's', 'i', 'z', 'e', '\030', '\002', ' ', '\001', '(', '\004',
                                     'R', '\010', 'h', 'e',
                                     'a', 'p', 'S', 'i', 'z', 'e', '\022', '+', '\n', '\021', 'p',
                                     'a', 'g', 'e', 'h', 'e', 'a', 'p', '_', 'u', 'n', 'm', 'a',
                                     'p', 'p',
                                     'e', 'd', '\030', '\003', ' ', '\001', '(', '\004', 'R',
                                     '\020', 'p', 'a', 'g', 'e', 'h', 'e', 'a', 'p', 'U', 'n', 'm',
                                     'a', 'p', 'p', 'e',
                                     'd', '\022', '#', '\n', '\r', 'p', 'a', 'g', 'e', 'h', 'e',
                                     'a', 'p', '_', 'f', 'r', 'e', 'e', '\030', '\004', ' ', '\001',
                                     '(', '\004', 'R',
                                     '\014', 'p', 'a', 'g', 'e', 'h', 'e', 'a', 'p', 'F', 'r', 'e',
                                     'e', '\022', ',', '\n', '\022', 't', 'o', 't', 'a', 'l', '_',
                                     't', 'h',
                                     'r', 'e', 'a', 'd', '_', 'c', 'a', 'c', 'h', 'e', '\030',
                                     '\005', ' ', '\001', '(', '\004', 'R', '\020', 't', 'o', 't',
                                     'a', 'l', 'T', 'h',
                                     'r', 'e', 'a', 'd', 'C', 'a', 'c', 'h', 'e', '\022', '0', '\n',
                                     '\024', 't', 'o', 't', 'a', 'l', '_', 'p', 'h', 'y', 's', 'i',
                                     'c',
                                     'a', 'l', '_', 'b', 'y', 't', 'e', 's', '\030', '\006', ' ',
                                     '\001', '(', '\004', 'R', '\022', 't', 'o', 't', 'a', 'l', 'P',
                                     'h', 'y', 's',
                                     'i', 'c', 'a', 'l', 'B', 'y', 't', 'e', 's', ':', '!', '\232',
                                     '\305', '\210', '\036', '\034', '\n', '\032', 'e', 'n', 'v',
                                     'o', 'y', '.', 'a',
