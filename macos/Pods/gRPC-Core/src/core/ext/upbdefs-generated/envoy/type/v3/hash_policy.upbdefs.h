...
*
envoy_type_v3_HashPolicy_getmsgdef(upb_DefPool
*s) {
...
UPB_INLINE const upb_MessageDef
*
envoy_type_v3_HashPolicy_SourceIp_getmsgdef(upb_DefPool
*s) {
_upb_DefPool_LoadDefInit(s, &envoy_type_v3_hash_policy_proto_upbdefinit
);
return
...
UPB_INLINE const upb_MessageDef
*
envoy_type_v3_HashPolicy_FilterState_getmsgdef(upb_DefPool
*s) {
_upb_DefPool_LoadDefInit(s, &envoy_type_v3_hash_policy_proto_upbdefinit
);
return
