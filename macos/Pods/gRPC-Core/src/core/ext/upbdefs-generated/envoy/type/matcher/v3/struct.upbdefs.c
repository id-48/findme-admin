...
static const char descriptor[649] = {'\n', '\"', 'e', 'n', 'v', 'o', 'y', '/', 't', 'y', 'p', 'e',
                                     ...
                                     'l', 'i',
                                     'd', 'a', 't', 'e', '.', 'p', 'r', 'o', 't', 'o', '\"', '\276',
                                     '\002', '\n', '\r', 'S', 't', 'r', 'u', 'c', 't', 'M', 'a',
                                     't', 'c',
                                     'h', 'e', 'r', '\022', 'N', '\n', '\004', 'p', 'a', 't', 'h',
                                     '\030', '\002', ' ', '\003', '(', '\013', '2', '0', '.', 'e',
                                     'n', 'v', 'o', 'y',
                                     '.', 't', 'y', 'p', 'e', '.', 'm', 'a', 't', 'c', 'h', 'e',
                                     'r', '.', 'v', '3', '.', 'S', 't', 'r', 'u', 'c', 't', 'M',
                                     'a',
                                     't', 'c', 'h', 'e', 'r', '.', 'P', 'a', 't', 'h', 'S', 'e',
                                     'g', 'm', 'e', 'n', 't', 'B', '\010', '\372', 'B', '\005',
                                     '\222', '\001', '\002',
                                     '\010', '\001', 'R', '\004', 'p', 'a', 't', 'h', '\022', 'C',
                                     '\n', '\005', 'v', 'a', 'l', 'u', 'e', '\030', '\003', ' ',
                                     '\001', '(', '\013', '2', '#',
                                     '.', 'e', 'n', 'v', 'o', 'y', '.', 't', 'y', 'p', 'e', '.',
                                     'm', 'a', 't', 'c', 'h', 'e', 'r', '.', 'v', '3', '.', 'V',
                                     'a',
                                     'l', 'u', 'e', 'M', 'a', 't', 'c', 'h', 'e', 'r', 'B', '\010',
                                     ...
                                     '\210', '\036', '\"', '\n', ' ', 'e',
                                     'n', 'v', 'o', 'y', '.', 't', 'y', 'p', 'e', '.', 'm', 'a',
                                     't', 'c', 'h', 'e', 'r', '.', 'S', 't', 'r', 'u', 'c', 't',
                                     'M',
                                     'a', 't', 'c', 'h', 'e', 'r', 'B', '\204', '\001', '\n', '#',
                                     'i', 'o', '.', 'e', 'n', 'v', 'o', 'y', 'p', 'r', 'o', 'x',
                                     'y', '.',
                                     'e', 'n', 'v', 'o', 'y', '.', 't', 'y', 'p', 'e', '.', 'm',
                                     'a', 't', 'c', 'h', 'e', 'r', '.', 'v', '3', 'B', '\013', 'S',
                                     't',
                                     'r', 'u', 'c', 't', 'P', 'r', 'o', 't', 'o', 'P', '\001', 'Z',
                                     'F', 'g', 'i', 't', 'h', 'u', 'b', '.', 'c', 'o', 'm', '/',
                                     'e',
