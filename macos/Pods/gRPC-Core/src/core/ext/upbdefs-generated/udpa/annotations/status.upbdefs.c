...
static const char descriptor[483] = {'\n', '\035', 'u', 'd', 'p', 'a', '/', 'a', 'n', 'n', 'o', 't',
                                     ...
                                     '\n', '\020', 'S', 't', 'a', 't', 'u', 's', 'A', 'n', 'n', 'o',
                                     't', 'a',
                                     't', 'i', 'o', 'n', '\022', '(', '\n', '\020', 'w', 'o', 'r',
                                     'k', '_', 'i', 'n', '_', 'p', 'r', 'o', 'g', 'r', 'e', 's',
                                     's', '\030',
                                     '\001', ' ', '\001', '(', '\010', 'R', '\016', 'w', 'o', 'r',
                                     'k', 'I', 'n', 'P', 'r', 'o', 'g', 'r', 'e', 's', 's', '\022',
                                     '\\', '\n', '\026',
                                     'p', 'a', 'c', 'k', 'a', 'g', 'e', '_', 'v', 'e', 'r', 's',
                                     'i', 'o', 'n', '_', 's', 't', 'a', 't', 'u', 's', '\030',
                                     '\002', ' ',
                                     '\001', '(', '\016', '2', '&', '.', 'u', 'd', 'p', 'a', '.',
                                     'a', 'n', 'n', 'o', 't', 'a', 't', 'i', 'o', 'n', 's', '.',
                                     'P', 'a',
                                     'c', 'k', 'a', 'g', 'e', 'V', 'e', 'r', 's', 'i', 'o', 'n',
                                     'S', 't', 'a', 't', 'u', 's', 'R', '\024', 'p', 'a', 'c', 'k',
                                     'a',
                                     'g', 'e', 'V', 'e', 'r', 's', 'i', 'o', 'n', 'S', 't', 'a',
                                     't', 'u', 's', '*', ']', '\n', '\024', 'P', 'a', 'c', 'k', 'a',
                                     'g',
                                     ...
                                     'T', 'I', 'V', 'E', '\020',
                                     '\002', '\022', ' ', '\n', '\034', 'N', 'E', 'X', 'T', '_',
                                     'M', 'A', 'J', 'O', 'R', '_', 'V', 'E', 'R', 'S', 'I', 'O',
                                     'N', '_', 'C',
                                     'A', 'N', 'D', 'I', 'D', 'A', 'T', 'E', '\020', '\003', ':',
                                     'd', '\n', '\013', 'f', 'i', 'l', 'e', '_', 's', 't', 'a', 't',
                                     'u', 's',
                                     '\022', '\034', '.', 'g', 'o', 'o', 'g', 'l', 'e', '.', 'p',
                                     'r', 'o', 't', 'o', 'b', 'u', 'f', '.', 'F', 'i', 'l', 'e',
                                     'O', 'p',
                                     't', 'i', 'o', 'n', 's', '\030', '\207', '\200', '\231', 'j',
                                     ' ', '\001', '(', '\013', '2', '\"', '.', 'u', 'd', 'p', 'a',
                                     '.', 'a', 'n', 'n',
                                     'o', 't', 'a', 't', 'i', 'o', 'n', 's', '.', 'S', 't', 'a',
                                     't', 'u', 's', 'A', 'n', 'n', 'o', 't', 'a', 't', 'i', 'o',
                                     'n',
                                     'R', '\n', 'f', 'i', 'l', 'e', 'S', 't', 'a', 't', 'u', 's',
                                     'B', '$', 'Z', '\"', 'g', 'i', 't', 'h', 'u', 'b', '.', 'c',
                                     'o',
