...
namespace grpc_core {
    ...
    public:
        ...
        StringMatcher(StringMatcher &&other)

        noexcept;

        StringMatcher &operator=(StringMatcher &&other)
    ...
    public:
        ...
        <StringMatcher::Type>(Type::kExact)
        ==
        StringMatcher::Type::kExact,
        "");
        static_assert(static_cast
        <StringMatcher::Type>(Type::kPrefix)
        ==
        StringMatcher::Type::kPrefix,
        "");
        static_assert(static_cast
        <StringMatcher::Type>(Type::kSuffix)
        ==
        StringMatcher::Type::kSuffix,
        "");
        static_assert(static_cast
        <StringMatcher::Type>(Type::kSafeRegex)
        ==
        StringMatcher::Type::kSafeRegex,
        "");
        static_assert(static_cast
        <StringMatcher::Type>(Type::kContains)
        ==
        ...
        HeaderMatcher(HeaderMatcher &&other)

        noexcept;

        HeaderMatcher &operator=(HeaderMatcher &&other)
