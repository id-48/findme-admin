...
//
    ...
    StringMatcher::StringMatcher(StringMatcher &&other)

    noexcept
    :
    type_(other
    .type_),
    case_sensitive_(other
    .case_sensitive_) {
    if (type_ == Type::kSafeRegex) {
...
StringMatcher &StringMatcher::operator=(StringMatcher &&other)
...
HeaderMatcher::HeaderMatcher(HeaderMatcher &&other)
...
HeaderMatcher &HeaderMatcher::operator=(HeaderMatcher &&other)
