...
Rbac::CidrRange::CidrRange(Rbac::CidrRange &&other)
...
Rbac::CidrRange &Rbac::CidrRange::operator=(Rbac::CidrRange &&other)
...
Rbac::Permission::Permission(Rbac::Permission &&other)
...
Rbac::Principal::Principal(Rbac::Principal &&other)
...
Rbac::Principal &Rbac::Principal::operator=(Rbac::Principal &&other)
...
Rbac::Policy::Policy(Rbac::Policy &&other)
...
Rbac::Policy &Rbac::Policy::operator=(Rbac::Policy &&other)
