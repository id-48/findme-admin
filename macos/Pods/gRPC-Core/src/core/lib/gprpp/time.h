...
public:
    ...
    FromMillisecondsAfterProcessEpoch(int64_t
    millis) {
    ...
    ProcessEpoch() { return Timestamp(0); }
...
public:
    ...
    Zero() { return Duration(0); }

    // Smallest representatable positive duration.
    static constexpr Duration

    Epsilon() { return Duration(1); }
