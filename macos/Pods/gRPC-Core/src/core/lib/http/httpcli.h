...
//                same content and combining them
    ...
    private:
        ...
        ABSL_EXCLUSIVE_LOCKS_REQUIRED(mu_) {DoRead();}
        ...
        ABSL_GUARDED_BY(mu_);
        size_t next_address_
        ABSL_GUARDED_BY(mu_) = 0;
        int have_read_byte_
        ABSL_GUARDED_BY(mu_) = 0;
        ...
        ABSL_GUARDED_BY(mu_);
        grpc_error_handle overall_error_
        ABSL_GUARDED_BY(mu_) = GRPC_ERROR_NONE;
