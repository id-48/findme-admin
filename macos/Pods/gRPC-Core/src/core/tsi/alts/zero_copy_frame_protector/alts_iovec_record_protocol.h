...
constexpr size_t
kZeroCopyFrameMessageType = 0x06;
constexpr size_t
kZeroCopyFrameLengthFieldSize = 4;
constexpr size_t
kZeroCopyFrameMessageTypeFieldSize = 4;
constexpr size_t
kZeroCopyFrameHeaderSize =
...
constexpr size_t
kAltsRecordProtocolRekeyFrameLimit = 8;
constexpr size_t
kAltsRecordProtocolFrameLimit = 5;
