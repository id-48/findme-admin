...
*
grpc_raw_byte_buffer_create(grpc_slice
* slices,
size_t nslices
);
...
grpc_raw_compressed_byte_buffer_create(
        grpc_slice
* slices,
size_t nslices, grpc_compression_algorithm
compression);
...
GRPCAPI grpc_byte_buffer
*
grpc_byte_buffer_copy(grpc_byte_buffer
* bb);

/** Returns the size of the given byte buffer, in bytes. */
GRPCAPI size_t
grpc_byte_buffer_length(grpc_byte_buffer
* bb);
...
GRPCAPI grpc_slice
grpc_byte_buffer_reader_readall(grpc_byte_buffer_reader
* reader);
