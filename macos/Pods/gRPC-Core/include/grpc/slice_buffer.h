...
GPRAPI size_t
grpc_slice_buffer_add_indexed(grpc_slice_buffer
* sb,
grpc_slice slice
);
...
GPRAPI uint8_t
*
grpc_slice_buffer_tiny_add(grpc_slice_buffer
* sb,
size_t len
);
...
GPRAPI void grpc_slice_buffer_trim_end(grpc_slice_buffer * sb, size_t
n,
grpc_slice_buffer *garbage
);
/** move the first n bytes of src into dst */
GPRAPI void grpc_slice_buffer_move_first(grpc_slice_buffer * src, size_t
n,
grpc_slice_buffer *dst
);
...
GPRAPI grpc_slice
grpc_slice_buffer_take_first(grpc_slice_buffer
* sb);
