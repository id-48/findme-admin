...
*
grpc_call_auth_context(grpc_call
* call);
...
GRPCAPI grpc_arg
grpc_ssl_session_cache_create_channel_arg(grpc_ssl_session_cache
* cache);
...
GRPCAPI gpr_timespec

grpc_max_auth_token_lifetime(void);
...
grpc_call_set_credentials(grpc_call
* call,
...
GRPCAPI void grpc_server_credentials_set_auth_metadata_processor(
        grpc_server_credentials * creds, grpc_auth_metadata_processor
processor);
 ...
 */
GRPCAPI grpc_tls_identity_pairs
*
...
grpc_tls_credentials_options_create(void);
...
GRPCAPI void grpc_tls_credentials_options_set_verify_server_cert(
        grpc_tls_credentials_options * options, int
verify_server_cert);
