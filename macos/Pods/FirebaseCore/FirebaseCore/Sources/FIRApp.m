 ...
 * events from Core.
 */
static NSMutableArray<Class <FIRLibrary>> *
...
+ (BOOL)validateAppID:(NSString *)appID {
    ...
    if (![knownVersions containsObject:appIDVersion]) {
        ...
        FIRLogInfo(kFIRLoggerCore, @"I-COR000010", @"Unknown GOOGLE_APP_ID version: %@",
                   appIDVersion);
        return YES;
    }
...
*)readDataCollectionSwitchFromUserDefaultsForApp:(FIRApp *)app {
...
*)readDataCollectionSwitchFromPlist {
