...
public enum QueryPredicate {
    ...
    case arrayContains(_
    field: String, _
    value: Any)
    case arrayContainsAny(_
    field: String, _
    values: [Any])
    ...
    case isLessThanOrEqualTo(_
    field: String, _
    value: Any)
    case isGreaterThanOrEqualTo(_
    field: String, _
    value: Any)
    ...
    public static func
    whereField(_
    field: String, isEqualTo
    value: Any) -> QueryPredicate {
    ...
    whereField(_
    field: String, isIn
    values: [Any]) -> QueryPredicate {
        .isIn(field, values)
    }

    public static func
    whereField(_
    field: String, isNotIn
    values: [Any]) -> QueryPredicate {
    ...
    public static func
    order(by
    field: String, descending
    value: Bool = false) -> QueryPredicate {
        .orderBy(field, value)
    }

    public static func
    limit(to
    value: Int) -> QueryPredicate {
        .limitTo(value)
    }
    ...
    public static func `where`(_
    name: String, isEqualTo
    value: Any) -> QueryPredicate {
    ...
    public static func `where`(field
    name: String, arrayContains
    value: Any) -> QueryPredicate {
        .arrayContains(name, value)
    }

    public static func `where`(_
    name: String, arrayContainsAny
    values: [Any]) -> QueryPredicate {
        .arrayContainsAny(name, values)
    }

    public static func `where`(_
    name: String, isLessThan
    value: Any) -> QueryPredicate {
        .isLessThan(name, value)
    }

    public static func `where`(_
    name: String, isGreaterThan
    value: Any) -> QueryPredicate {
        .isGreaterThan(name, value)
    }

    public static func `where`(_
    name: String, isLessThanOrEqualTo
    value: Any) -> QueryPredicate {
