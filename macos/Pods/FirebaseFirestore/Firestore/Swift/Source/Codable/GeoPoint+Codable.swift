...
extension CodableGeoPoint{
        public init(from decoder: Decoder) throws {
            ...
            container =
            try
            decoder.container(keyedBy: GeoPointKeys.self)
            let
            latitude =
            try
        ...
        public func encode(to encoder: Encoder) throws {
            var
            container = encoder.container(keyedBy: GeoPointKeys.self)
            try
            container.encode(latitude, forKey: .latitude)
            try
            container.encode(longitude, forKey: .longitude)
        }
}
