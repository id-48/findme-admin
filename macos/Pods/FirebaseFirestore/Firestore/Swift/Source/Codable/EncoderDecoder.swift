...
extension Firestore{
        class Encoder {
            ...
            FirebaseDataEncoder.DateEncodingStrategy = .timestamp

            /// Firestore encodes Data as `NSData` blobs versus the default .base64 strings.
            public var
            dataEncodingStrategy:
            FirebaseDataEncoder.DataEncodingStrategy = .blob
            ...
            public var
            keyEncodingStrategy:
            FirebaseDataEncoder.KeyEncodingStrategy = .useDefaultKeys
        ...
        class Decoder {
            ...
            FirebaseDataDecoder.DateDecodingStrategy = .timestamp

            /// Firestore decodes Data from `NSData` blobs versus the default .base64 strings.
            public var
            dataDecodingStrategy:
            FirebaseDataDecoder.DataDecodingStrategy = .blob
            ...
            public var
            keyDecodingStrategy:
            FirebaseDataDecoder.KeyDecodingStrategy = .useDefaultKeys
