...
static func wrap(_ timestamp

: Timestamp) throws -> Self {
return timestamp.
...
static func unwrap(_ value

: Self) throws -> Timestamp {
return
Timestamp(date
: value)
}
...
@propertyWrapper
public
struct ServerTimestamp<Value> : Codable
        where
Value:
ServerTimestampWrappable &Codable{
        var value: Value?
        ...
        public init(from decoder: Decoder) throws {
            ...
            if container.decodeNil()
            {
                ...
                value =
                try
                Value.wrap(container.decode(Timestamp.self))
            }
        }
        ...
        public func encode(to encoder: Encoder) throws {
            ...
            value = value{
                ...
                try
                container.encode(FieldValue.serverTimestamp())
            }
        }
}

extension ServerTimestamp
:
Equatable where
Value: Equatable {
}
