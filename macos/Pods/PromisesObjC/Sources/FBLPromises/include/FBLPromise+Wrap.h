 ...
 */
typedef void (^FBLPromiseCompletion)(void)
...
NS_SWIFT_UNAVAILABLE("");
typedef void (^FBLPromiseErrorOrObjectCompletion)(NSError * __nullable, id
__nullable)
NS_SWIFT_UNAVAILABLE("");
...
NS_SWIFT_UNAVAILABLE("");
typedef void (^FBLPromiseBoolCompletion)(BOOL)
NS_SWIFT_UNAVAILABLE("");
typedef void (^FBLPromiseBoolOrErrorCompletion)(BOOL, NSError * __nullable)
NS_SWIFT_UNAVAILABLE("");

typedef void (^FBLPromiseIntegerCompletion)(NSInteger)
...
typedef void (^FBLPromiseDoubleCompletion)(double)
 ...
 */
+ (instancetype)wrapCompletion:(void (^)(FBLPromiseCompletion handler
...
+ (instancetype)onQueue:(dispatch_queue_t)queue
         wrapCompletion:(void (^)(FBLPromiseCompletion handler

))
work NS_SWIFT_UNAVAILABLE("");
 ...
 */
+ (FBLPromise<NSNumber *> *)wrapIntegerCompletion:(void (^)(
        FBLPromiseIntegerCompletion handler))work
NS_SWIFT_UNAVAILABLE
...
+ (FBLPromise *(^)(void (^)(FBLPromiseCompletion)

))
wrapCompletion FBL_PROMISES_DOT_SYNTAX
        NS_SWIFT_UNAVAILABLE("");

+ (FBLPromise *(^)(dispatch_queue_t, void (^)(FBLPromiseCompletion)
...
+ (FBLPromise<NSNumber *> *(^)(dispatch_queue_t,
                               void (^)(
                                       FBLPromiseBoolOrErrorCompletion)))wrapBoolOrErrorCompletionOn
FBL_PROMISES_DOT_SYNTAX
