...
FOUNDATION_EXTERN NSTimeInterval
const FBLPromiseRetryDefaultDelayInterval NS_REFINED_FOR_SWIFT;

@interface FBLPromise<Value> (RetryAdditions)

typedef id __nullable(^FBLPromiseRetryWorkBlock)
...
retryAgainOn FBL_PROMISES_DOT_SYNTAX
        NS_SWIFT_UNAVAILABLE("");
