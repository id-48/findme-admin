...
LEVELDB_EXPORT const leveldb_snapshot_t
*
leveldb_create_snapshot(leveldb_t
* db);
...
const size_t *range_limit_key_len, uint64_t
* sizes);
...
LEVELDB_EXPORT uint8_t

leveldb_iter_valid(const leveldb_iterator_t *);
...
LEVELDB_EXPORT void leveldb_iter_seek(leveldb_iterator_t * ,
const char *k,
        size_t
klen);
...
LEVELDB_EXPORT leveldb_writebatch_t
*
...
LEVELDB_EXPORT void leveldb_writebatch_append(
        leveldb_writebatch_t * destination,
const leveldb_writebatch_t *source
);

/* Options */

LEVELDB_EXPORT leveldb_options_t
*
...
LEVELDB_EXPORT leveldb_filterpolicy_t
*
...
LEVELDB_EXPORT leveldb_readoptions_t
*
...
LEVELDB_EXPORT leveldb_writeoptions_t
*
...
LEVELDB_EXPORT leveldb_cache_t
*
