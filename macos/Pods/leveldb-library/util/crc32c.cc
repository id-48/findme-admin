...
// CRCs are pre- and post- conditioned by xoring with all ones.
            ...
            kCRC32Xor = static_cast<uint32_t>(0xffffffffU);
...
// N must be a power of two.
            template<int N>
            constexpr inline const uint8_t
            *

            RoundUp(const uint8_t *pointer) {
...
// calculation.
        ...
        if (accelerate) {
        return
        port::AcceleratedCRC32C(crc, data, n
        );
    }
