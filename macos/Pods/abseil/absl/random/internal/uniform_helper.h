...
//
        ...
        IntType>
        uniform_lower_bound(Tag, IntType
        a, IntType) {
        return a < (std::numeric_limits<IntType>::max)() ? (a + 1) :
        a;
    }
    ...
    typename absl::enable_if_t<
            ...
            std::is_same < Tag, IntervalOpenOpenTag>>>::value,
    FloatType>
    uniform_lower_bound(Tag, FloatType
    a,
    FloatType b
    ) {
    return
...
::value,
NumType>
uniform_lower_bound(Tag, NumType
a, NumType) {
return
a;
}
...
typename absl::enable_if_t<
        ...
        std::is_same < Tag, IntervalOpenOpenTag>>>::value,
IntType>
uniform_upper_bound(Tag, IntType, IntType
b) {
return b > (std::numeric_limits<IntType>::min)() ? (b - 1) :
b;
}
...
typename absl::enable_if_t<
        ...
        std::is_same < Tag, IntervalOpenOpenTag>>>::value,
FloatType>
uniform_upper_bound(Tag, FloatType, FloatType
b) {
return
b;
}
...
b) {
return
std::nextafter(b, (std::numeric_limits<FloatType>::max)()
);
}
