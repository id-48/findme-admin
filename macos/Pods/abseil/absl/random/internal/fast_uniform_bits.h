...
// URBG::result_type.
        ...
        constexpr typename URBG::result_type
...
FastUniformBits<UIntType>::Generate(URBG &g,  // NOLINT(runtime/references)
    ...
    static constexpr size_t
    kUrbgBits = NumBits<URBG>();
    static constexpr size_t
    kIters =
            (kResultBits / kUrbgBits) + (kResultBits % kUrbgBits != 0);
    static constexpr size_t
    kShift = (kIters == 1) ? 0 : kUrbgBits;
...
FastUniformBits<UIntType>::Generate(URBG &g,  // NOLINT(runtime/references)
    ...
    static constexpr urbg_result_type
    kUrbgRange = RangeSize<URBG>();  // R
    static constexpr size_t
    kUrbgBits = NumBits<URBG>();               // m
    ...
    static constexpr size_t
    kSmallBits = kResultBits / kTotalIters;  // w0
    static constexpr urbg_result_type
    kSmallRejection =
            ((kUrbgRange >> kSmallBits) << kSmallBits);  // y0

    static constexpr size_t
    kLargeBits = kSmallBits + 1;  // w0+1
    static constexpr urbg_result_type
    kLargeRejection =
