...
// guarantees that if cs1 < cs2, then convert(cs1, tz) <= convert(cs2, tz).
            ...
            namespace detail {
                ...
                bool join_seconds(
                        ...
                        time_point<std::chrono::duration < Rep, std::ratio < 1, Denom>>
                ...
                bool join_seconds(
                        const time_point<seconds> &sec, const femtoseconds &fs,
                        time_point<std::chrono::duration < Rep, std::ratio < Num, 1>>
                ...
                bool join_seconds(
                        const time_point<seconds> &sec, const femtoseconds &fs,
                        time_point<std::chrono::duration < Rep, std::ratio < 1, 1>>
