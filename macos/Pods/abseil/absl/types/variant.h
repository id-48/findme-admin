...
//
    ...
    void swap(variant<Ts...> &v, variant<Ts...> &w)
...
& v) {  // NOLINT
return
variant_internal::VariantCoreAccess::CheckedAccess<
...
& v) {  // NOLINT
return
variant_internal::VariantCoreAccess::CheckedAccess<I>(v);
}
...
&& v) {
return
variant_internal::VariantCoreAccess::CheckedAccess<I>(absl::move(v)
);
}
...
* v) noexcept {
return
absl::get_if<variant_internal::IndexOf<T, Types...>::value>(v);
}
...
class variant<T0, Tn...> : private variant_internal::VariantBase<T0, Tn...> {
    ...
    static_assert(absl::conjunction<std::is_nothrow_destructible < T0>,
            std::is_nothrow_destructible<Tn>
    ...>::value,
...
public:
    ...
    noexcept(std::is_nothrow_constructible<Tj, T>::value)
