...
// ClangTidy warning in user code.
        ...
        struct OnlyLiteralZero {
            constexpr OnlyLiteralZero(NullPtrT)
...
// aren't available in C++11).
    ...
    class weak_equality
        ...
        explicit constexpr weak_equality(compare_internal::eq v)
    ...
    class strong_equality
        ...
        explicit constexpr strong_equality(compare_internal::eq v)
    ...
    public:
        ...
        // Conversion
        constexpr operator weak_equality() const
    ...
    class partial_ordering
        ...
        explicit constexpr partial_ordering(compare_internal::eq v)

        noexcept
                : value_(static_cast<compare_internal::value_type>(v)) {}

        explicit constexpr partial_ordering(compare_internal::ord v)

        noexcept
                : value_(static_cast<compare_internal::value_type>(v)) {}

        explicit constexpr partial_ordering(compare_internal::ncmp v)

        noexcept
                : value_(static_cast<compare_internal::value_type>(v)) {}
        friend struct compare_internal::partial_ordering_base<partial_ordering>;

        constexpr bool is_ordered() const
    ...
    class weak_ordering
        ...
        explicit constexpr weak_ordering(compare_internal::eq v)

        noexcept
                : value_(static_cast<compare_internal::value_type>(v)) {}

        explicit constexpr weak_ordering(compare_internal::ord v)
    ...
    class strong_ordering
        ...
        explicit constexpr strong_ordering(compare_internal::eq v)

        noexcept
                : value_(static_cast<compare_internal::value_type>(v)) {}

        explicit constexpr strong_ordering(compare_internal::ord v)
    ...
    public:
        ...
        constexpr operator strong_equality() const
...
// SFINAE prevents implicit conversions to int (such as from bool).
        ...
        compare_result_as_ordering(const Int c) {
        ...
        do_three_way_comparison(const Compare &compare,
