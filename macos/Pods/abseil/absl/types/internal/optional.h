...
#pragma GCC diagnostic pop
            ...
            constexpr optional_data_dtor_base()

            noexcept : engaged_(false), dummy_{{}} {}
...
// Trivially copyable types
        ...
        protected:
            ...
            optional_data(optional_data &&rhs)
            ...
            optional_data &operator=(optional_data &&rhs)
