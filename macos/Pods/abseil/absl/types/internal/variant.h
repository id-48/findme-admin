...
namespace absl {
    ...
    ABSL_INTERNAL_INLINE_CONSTEXPR(size_t, variant_npos,
...
// NOTE: This is used instead of std::array to reduce instantiation overhead.
        ...
        AccessSimpleArray(const T &value) {
            return value;
        }
        ...
        AccessSimpleArray(const SimpleArray<T, Size> &table,
...
// Note: Intentionally is an alias.
        ...
        call_with_indices(FunctionObject
        && function) {
        static_assert(
        ...
        absl::forward<FunctionObject> (function)(SizeT<Indices>()...);
    }
...
ABSL_INTERNAL_INLINE_CONSTEXPR(std::size_t, MaxUnrolledVisitCases,
33);
...
struct PerformVisitation {
    ...
    operator()(SizeT <Is>... indices) const {
    ...
    constexpr ReturnType
    Run(std::false_type /*has_valueless*/,
            index_sequence<TupIs...>, SizeT<Is>
    ...) const {
        static_assert(
...
template<>
union Union<> {
    constexpr explicit Union(NoopConstructorTag)
...
union Union<Head, Tail...> {
    ...
    explicit constexpr Union(NoopConstructorTag /*tag*/)
...
template<>
union DestructibleUnionImpl<> {
    constexpr explicit DestructibleUnionImpl(NoopConstructorTag)
...
union DestructibleUnionImpl<Head, Tail...> {
    ...
    explicit constexpr DestructibleUnionImpl(NoopConstructorTag /*tag*/)
...
protected:
    ...
    struct Destroyer {
        ...
        void operator()(SizeT <I> i) const {
            using Alternative =
                    typename absl::variant_alternative<I, variant < T...>>
            ::type;
...
protected:
    ...
    VariantMoveBaseNontrivial(VariantMoveBaseNontrivial &&other)
...
protected:
    ...
    operator=(VariantMoveAssignBaseNontrivial &&other)
