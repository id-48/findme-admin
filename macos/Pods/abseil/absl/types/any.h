...
// and is designed to be a drop-in replacement for code compliant with C++17.
    ...
    private:
        ...
        public:
            ...
            virtual const void *ObjTypeId() const
        ...
        public:
            ...
            const void *ObjTypeId() const

            noexcept final{return IdForType<T>();}
...
? std::addressof(
static_cast<any::Obj<U>*>(operand->obj_.
