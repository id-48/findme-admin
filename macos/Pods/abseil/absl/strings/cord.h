...
//
    ...
    public:
        ...
        friend void swap(Cord &x, Cord &y)
    ...
    private:
        ...
        public:
            ...
            static_assert(kMaxInline
            >= sizeof(absl::cord_internal::CordRep*), "");
...
inline void Cord::swap(Cord &other)
...
inline Cord &Cord::operator=(Cord &&x)
