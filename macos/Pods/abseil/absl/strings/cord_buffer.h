...
// CordBuffer is thread compatible.
    ...
    public:
        ...
        kDefaultLimit = cord_internal::kMaxFlatLength;
    ...
    private:
        ...
        static_assert(kCustomLimit
        <= cord_internal::kMaxLargeFlatSize, "");
        ...
        static constexpr size_t
        kOverhead = cord_internal::kFlatOverhead;
        ...
        struct Rep {
            ...
            static constexpr size_t
            kInlineCapacity = sizeof(intptr_t) * 2 - 1;
    ...
    inline constexpr size_t
    CordBuffer::MaximumPayload(size_t
    block_size) {
...
inline CordBuffer::CordBuffer(CordBuffer &&rhs)
...
inline CordBuffer &CordBuffer::operator=(CordBuffer &&rhs)
...
cord_internal::CordRepFlat::Delete(rep_
.
