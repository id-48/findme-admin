...
// An abstraction to which conversions write their string data.
        ...
        return static_cast<Flags>(static_cast
        <uint8_t>(a)
        | static_cast
        <uint8_t>(b)
        );
...
#undef ABSL_INTERNAL_X_VAL
        static constexpr FormatConversionChar
        kNone =
...
|
static_cast
<uint64_t>(FormatConversionCharSetUnion(rest...)
));
}

constexpr uint64_t
FormatConversionCharToConvInt(FormatConversionChar
c) {
return uint64_t{
1} << (1 + static_cast
<uint8_t>(c)
...
FormatConversionCharToConvInt(char conv) {
    return
...
FormatConversionCharToConvValue(char conv) {
    return static_cast<FormatConversionCharSet>(
...
#undef ABSL_INTERNAL_CHAR_SET_CASE
    ...
    static constexpr FormatConversionCharSet
    kStar =
...
//  2. We use "enum class" which would not work even if we accepted the decay.
constexpr FormatConversionCharSet
operator|(FormatConversionCharSet
a,
FormatConversionCharSet b
) {
return
FormatConversionCharSetUnion(a, b
);
}
...
ToFormatConversionCharSet(char c) {
    return static_cast<FormatConversionCharSet>(
...
constexpr bool Contains(FormatConversionCharSet
set,
char c
) {
return (static_cast
...
&
static_cast
<uint64_t>(FormatConversionCharToConvValue(c)
)) != 0;
}
...
<uint64_t>(set)
&
FormatConversionCharToConvInt(c)
) != 0;
}
