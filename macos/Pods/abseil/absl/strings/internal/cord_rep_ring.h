...
//
        ...
        public:
            ...
            kMaxCapacity = (std::numeric_limits<uint32_t>::max)();
        ...
        private:
            ...
            static constexpr size_t
            kLayoutAlignment = Layout::Partial().Alignment();
        ...
        constexpr size_t
        CordRepRing::AllocSize(size_t
        capacity) {
        return sizeof(CordRepRing) - sizeof(data_) +
        Layout(capacity, capacity, capacity
        ).
