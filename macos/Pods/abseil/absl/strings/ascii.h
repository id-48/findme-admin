...
// Creates a lowercase string from a given absl::string_view.
    ...
    AsciiStrToLower(absl::string_view
    s) {
    std::string result(s);
...
ABSL_MUST_USE_RESULT inline std::string
AsciiStrToUpper(absl::string_view
s) {
std::string result(s);
...
str) {
return
StripTrailingAsciiWhitespace(StripLeadingAsciiWhitespace(str)
);
}
