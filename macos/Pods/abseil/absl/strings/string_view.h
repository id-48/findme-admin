...
//   absl::string_view(nullptr, 0) == absl::string_view("abcdef"+6, 0)
    ...
    public:
        ...
        ABSL_INTERNAL_STRING_VIEW_CXX14_CONSTEXPR void swap(string_view &s)
        ...
        // is greater than `x`.
        constexpr int compare(string_view x) const
    ...
    private:
        ...
        string_view(const char *data, size_type len, SkipCheckLengthTag)
...
// following comparisons.
    constexpr bool operator==(string_view x, string_view y)
    ...
    ||
    ABSL_INTERNAL_STRING_VIEW_MEMCMP(x
    .
...
NullSafeStringView(const char *p) {
