...
type_traits_internal::IsTriviallyMoveAssignableReference <T>>
::type::
type {
...
private:
    ...
    decltype(std::declval<std::hash < Key>>
    ()(
    ...
    static std::nullptr_t DoIt() {
        ...
        static_assert(absl::is_copy_assignable<std::hash < Key>>
        ::value,
