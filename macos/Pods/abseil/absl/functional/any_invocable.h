...
// implementation.
    ...
    public:
        ...
        // although it may be.
        AnyInvocable &operator=(AnyInvocable && /*f*/)
        ...
        void swap(AnyInvocable &other)

        noexcept { std::swap(*this, other); }
        ...
        friend void swap(AnyInvocable &f1, AnyInvocable &f2)
