...
constexpr bool operator==(uint128
lhs,
uint128 rhs
) {
#if defined(ABSL_HAVE_INTRINSIC_INT128)
...
MakeUint128(
        ~Uint128High64(val)
+ static_cast
<unsigned long>(Uint128Low64(val)
== 0),
~
Uint128Low64(val)
+ 1);
...
constexpr inline bool operator!(uint128
val) {
#if defined(ABSL_HAVE_INTRINSIC_INT128)
return !static_cast<unsigned __int128>(val);
#else
...
#else
return
MakeUint128(~Uint128High64(val), ~Uint128Low64(val)
);
#endif
}
...
inline uint128 &uint128::operator|=(uint128
other) {
*this = *this |
other;
return *this;
...
// uint64_t shifts of >= 64 are undefined, so we will need some
// special-casing.
return amount >= 64 ? MakeUint128(0,
Uint128High64(lhs)
>> (amount - 64))
: amount == 0 ? lhs
:
...
namespace int128_internal {
    ...
    ?
    MakeUint128(Uint128High64(result)
    + 1,
    Uint128Low64(result)
    )
    :
...
#else
return
int128_internal::SubstructResult(
        MakeUint128(Uint128High64(lhs) - Uint128High64(rhs),
                    Uint128Low64(lhs) - Uint128Low64(rhs)),
        lhs, rhs
);
...
inline uint128 operator*(uint128
lhs,
uint128 rhs
) {
#if defined(ABSL_HAVE_INTRINSIC_INT128)
...
inline int128 &int128::operator+=(int128
other) {
*this = *this +
other;
return *this;
...
constexpr bool operator!=(int128
lhs,
int128 rhs
);
