 ...
 */
extern void GULLogError(GULLoggerService
service,
BOOL force,
        NSString
*messageCode,
...
extern void GULLogWarning(GULLoggerService
service,
BOOL force,
        NSString
*messageCode,
...
extern void GULLogNotice(GULLoggerService
service,
BOOL force,
        NSString
*messageCode,
...
extern void GULLogInfo(GULLoggerService
service,
BOOL force,
        NSString
*messageCode,
...
extern void GULLogDebug(GULLoggerService
service,
BOOL force,
        NSString
*messageCode,
