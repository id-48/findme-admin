...
NSCache<NSString *, id <NSSecureCoding>> *
inMemoryCache;
@end
...
- (instancetype)initWithService:(NSString *)service cache:(NSCache *)cache {
    ...
    if (self) {
        ...
        _inMemoryCacheQueue =
                dispatch_queue_create("com.gul.KeychainStorage.InMemoryCache",
...
<id <NSSecureCoding>> *)getObjectForKey:(NSString *)
key
        objectClass
:(Class)
objectClass
...
<NSNull *> *)setObject:(id <NSSecureCoding>)
object
        forKey
:(NSString *)
key
...
<NSNull *> *)removeObjectForKey:(NSString *)
key
        accessGroup
:(
nullable NSString
...
<id <NSSecureCoding>> *)getObjectFromKeychainForKey:(NSString *)
key
        objectClass
:(Class)
objectClass
...
<NSString *, id> *)keychainQueryWithKey:(NSString *)
key
        accessGroup
:(
nullable NSString
