...
///
public
struct HeartbeatsPayload : Codable {
    ...
    let
    userAgentPayloads: [UserAgentPayload]
...
extension
HeartbeatsPayload: HTTPHeaderRepresentable {
...
extension Data{
        ...
        func zipped() throws -> Data {
            try
            NSData.gul_data(byGzippingData: self)
        }
        ...
        func unzipped() throws -> Data {
            try
            NSData.gul_data(byInflatingGzippedData: self)
        }
}
