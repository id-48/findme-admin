...
ResGetAllUser resGetAllUserFromJson(String str) => ResGetAllUser.fromJson(json.decode(str));
...
class ResGetAllUser {
  ...
  factory ResGetAllUser.fromJson(Map<String, dynamic> json) => ResGetAllUser(
    status: json["status"],
