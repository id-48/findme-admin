...
ReqUpdateBilling reqUpdateBillingFromJson(String str) =>
    ReqUpdateBilling.fromJson(json.decode(str));

String reqUpdateBillingToJson(ReqUpdateBilling data) =>
    json.encode(data.toJson());

class ReqUpdateBilling {
  String billingId;
  String billNo;
  String billingDate;
  String showroomId;
  ...
  factory ReqUpdateBilling.fromJson(Map<String, dynamic> json) =>
      ReqUpdateBilling(
