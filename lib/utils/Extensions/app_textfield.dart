...
class _AppTextFieldState extends State<AppTextField> {
  ...
  FormFieldValidator<String>? applyValidation() {
    if (widget.isValidationRequired ?? true) {
      if (widget.validator != null) {
        ...
        return (s) {
          if (s!.trim().isEmpty) return widget.errorThisFieldRequired.validate(
  ...
  Widget build(BuildContext context) {
    return TextFormField(
      ...
      textInputAction: applyTextInputAction(),
      onFieldSubmitted: (s) {
        if (widget.nextFocus != null) FocusScope.of(context).requestFocus(
            widget.nextFocus);
      ...
      decoration: widget.decoration != null
        ...
        suffixIcon: widget.textFieldType == TextFieldType.PASSWORD
          ...
          child: Icon(
            ...
            color: widget.suffixIconColor ?? Theme
                .of(context)
                .iconTheme
                .color,
          ),
      ...
      maxLines: widget.textFieldType == TextFieldType.ADDRESS ? null : widget
          .maxLines ?? 1,
      minLines: widget.minLines ?? 1,
      autofocus: widget.autoFocus ?? false,
      enabled: widget.enabled,
      onChanged: widget.onChanged,
      cursorColor: widget.cursorColor ?? Theme
          .of(context)
          .textSelectionTheme
          .cursorColor,
